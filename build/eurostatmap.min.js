    ...
    return (function () {
        ...
        function f(t, e, n, r, i, a) {
            for (var o, l = 0, s = e.length, u = a.length; l < u; ++l)
                (o = e[l]) ? ((o.__data__ = a[l]), (r[l] = o)) : (n[l] = new c(t, a[l]))
        ...
        function h(t, e, n, r, i, a, o) {
            var l,
                ...
                d = new Array(h)
            for (l = 0; l < h; ++l)
                (s = e[l]) && ((d[l] = u = '$' + o.call(s, s.__data__, l, e)), u in f ? (i[l] = s) : (f[u] = s))
            for (l = 0; l < p; ++l)
                (s = f[(u = '$' + o.call(t, a[l], l, a))])
                    ? ((r[l] = s), (s.__data__ = a[l]), (f[u] = null))
                    : (n[l] = new c(t, a[l]))
            for (l = 0; l < h; ++l) (s = e[l]) && f[d[l]] === s && (i[l] = s)
        }
        function p(t, e) {
        ...
        function P(t, e) {
            for (var n = L(t), r = -1, i = e.length; ++r < i; ) n.add(e[r])
        }
        function D(t, e) {
            for (var n = L(t), r = -1, i = e.length; ++r < i; ) n.remove(e[r])
        }
        function O(t) {
            return function () {
                P(this, t)
        ...
        function I(t, e) {
            return function () {
                ;(e.apply(this, arguments) ? P : D)(this, t)
            }
        }
        function W() {
            this.textContent = ''
        ...
        function ot(t, e, n) {
            var r = tt.hasOwnProperty(t.type) ? nt : rt
            return function (i, a, o) {
                ...
                if (s)
                    for (var c = 0, f = s.length; c < f; ++c)
                        if ((l = s[c]).type === t.type && l.name === t.name)
                            return (
                                this.removeEventListener(l.type, l.listener, l.capture),
                                this.addEventListener(l.type, (l.listener = u), (l.capture = n)),
                                void (l.value = e)
                            )
                this.addEventListener(t.type, u, n),
                    (l = { type: t.type, name: t.name, value: e, listener: u, capture: n }),
        ...
        function ut(t, e) {
            return function () {
                return lt(this, t, e.apply(this, arguments))
            }
        }
        ...
        ft.prototype = ht.prototype = {
            ...
            select: function (t) {
                ...
                for (var e = this._groups, n = e.length, r = new Array(n), i = 0; i < n; ++i)
                    for (var o, l, s = e[i], u = s.length, c = (r[i] = new Array(u)), f = 0; f < u; ++f)
                        (o = s[f]) &&
                            (l = t.call(o, o.__data__, f, s)) &&
                            ('__data__' in o && (l.__data__ = o.__data__), (c[f] = l))
                return new ft(r, this._parents)
            },
            selectAll: function (t) {
                'function' != typeof t && (t = l(t))
                for (var e = this._groups, n = e.length, r = [], i = [], a = 0; a < n; ++a)
                    for (var o, s = e[a], u = s.length, c = 0; c < u; ++c)
            ...
            filter: function (t) {
                ...
                for (var e = this._groups, n = e.length, r = new Array(n), i = 0; i < n; ++i)
                    for (var a, o = e[i], l = o.length, u = (r[i] = []), c = 0; c < l; ++c)
            ...
            data: function (t, e) {
                ...
                for (var o = a.length, l = new Array(o), s = new Array(o), u = new Array(o), c = 0; c < o; ++c) {
                    var p = i[c],
                        d = a[c],
                        g = d.length,
                        _ = t.call(p, p && p.__data__, c, i),
                        y = _.length,
                        v = (s[c] = new Array(y)),
                        m = (l[c] = new Array(y))
                    r(p, d, v, m, (u[c] = new Array(g)), _, e)
                    for (var x, b, S = 0, w = 0; S < y; ++S)
                        if ((x = v[S])) {
                            for (S >= w && (w = S + 1); !(b = m[w]) && ++w < y; );
                            x._next = b || null
                        }
                }
                return ((l = new ft(l, i))._enter = s), (l._exit = u), l
            },
            enter: function () {
                return new ft(this._enter || this._groups.map(u), this._parents)
            },
            exit: function () {
                return new ft(this._exit || this._groups.map(u), this._parents)
            },
            join: function (t, e, n) {
                var r = this.enter(),
                    i = this,
            ...
            merge: function (t) {
                for (
                    var e = this._groups, n = t._groups, r = e.length, i = n.length, a = Math.min(r, i), o = new Array(r), l = 0;
                    l < a;
                    ++l
                )
                    for (var s, u = e[l], c = n[l], f = u.length, h = (o[l] = new Array(f)), p = 0; p < f; ++p)
                        (s = u[p] || c[p]) && (h[p] = s)
                for (; l < r; ++l) o[l] = e[l]
            ...
            sort: function (t) {
                ...
                for (var n = this._groups, r = n.length, i = new Array(r), a = 0; a < r; ++a) {
                    for (var o, l = n[a], s = l.length, u = (i[a] = new Array(s)), c = 0; c < s; ++c) (o = l[c]) && (u[c] = o)
                    u.sort(e)
                }
            ...
            attr: function (t, e) {
                ...
                return this.each(
                    (null == e ? (n.local ? v : y) : 'function' == typeof e ? (n.local ? S : b) : n.local ? x : m)(n, e)
                )
            },
            style: function (t, e, n) {
                return arguments.length > 1
                    ? this.each((null == e ? T : 'function' == typeof e ? z : k)(t, e, null == n ? '' : n))
                    : F(this.node(), t)
            },
            property: function (t, e) {
                return arguments.length > 1 ? this.each((null == e ? A : 'function' == typeof e ? C : M)(t, e)) : this.node()[t]
            },
            classed: function (t, e) {
                ...
                return this.each(('function' == typeof e ? I : e ? O : R)(n, e))
            },
            text: function (t) {
                return arguments.length ? this.each(null == t ? W : ('function' == typeof t ? H : j)(t)) : this.node().textContent
            },
            html: function (t) {
                return arguments.length ? this.each(null == t ? U : ('function' == typeof t ? G : B)(t)) : this.node().innerHTML
            },
            raise: function () {
                return this.each(q)
            },
            ...
            insert: function (t, e) {
                var n = 'function' == typeof t ? t : K(t),
                    r = null == e ? J : 'function' == typeof e ? e : a(e)
                return this.select(function () {
            ...
            on: function (t, e, n) {
                var r,
                    ...
                    o = a.length
                if (!(arguments.length < 2)) {
                    for (l = e ? ot : at, null == n && (n = !1), r = 0; r < o; ++r) this.each(l(a[r], e, n))
                    return this
                }
                var l = this.node().__on
                if (l)
                    for (var s, u = 0, c = l.length; u < c; ++u)
                        for (r = 0, s = l[u]; r < o; ++r) if ((i = a[r]).type === s.type && i.name === s.name) return s.value
            },
            dispatch: function (t, e) {
                return this.each(('function' == typeof e ? ut : st)(t, e))
            },
        }
        var pt = ht
        function dt(t) {
            return 'string' == typeof t ? new ft([[document.querySelector(t)]], [document.documentElement]) : new ft([[t]], ct)
        }
        function gt(t, e) {
            return t < e ? -1 : t > e ? 1 : t >= e ? 0 : NaN
        }
        ...
        var bt = Array.prototype,
            St = (bt.slice, bt.map, Math.sqrt(50)),
            wt = Math.sqrt(10),
            Tt = Math.sqrt(2)
        function kt(t, e, n) {
            var r,
            ...
            if (((r = e < t) && ((i = t), (t = e), (e = i)), 0 === (o = zt(t, e, n)) || !isFinite(o))) return []
            if (o > 0)
                for (t = Math.ceil(t / o), e = Math.floor(e / o), a = new Array((i = Math.ceil(e - t + 1))); ++l < i; )
                    a[l] = (t + l) * o
            else
                for (t = Math.floor(t * o), e = Math.ceil(e * o), a = new Array((i = Math.ceil(t - e + 1))); ++l < i; )
                    a[l] = (t - l) / o
        ...
        function zt(t, e, n) {
            var r = (e - t) / Math.max(0, n),
                ...
                a = r / Math.pow(10, i)
            return i >= 0
                ? (a >= St ? 10 : a >= wt ? 5 : a >= Tt ? 2 : 1) * Math.pow(10, i)
                : -Math.pow(10, -i) / (a >= St ? 10 : a >= wt ? 5 : a >= Tt ? 2 : 1)
        }
        function Ft(t, e) {
            var n,
                r,
        ...
        Pt.prototype = Dt.prototype = {
            ...
            clear: function () {
                for (var t in this) t[0] === Nt && delete this[t]
            },
            keys: function () {
                var t = []
                for (var e in this) e[0] === Nt && t.push(e.slice(1))
                return t
            },
            values: function () {
                var t = []
                for (var e in this) e[0] === Nt && t.push(this[e])
                return t
            },
            entries: function () {
                var t = []
                for (var e in this) e[0] === Nt && t.push({ key: e.slice(1), value: this[e] })
                return t
            },
            size: function () {
                var t = 0
                for (var e in this) e[0] === Nt && ++t
                return t
            },
            empty: function () {
                for (var t in this) if (t[0] === Nt) return !1
                return !0
            },
            each: function (t) {
                for (var e in this) e[0] === Nt && t(this[e], e.slice(1), this)
            },
        }
        var Ot = Dt
        function Rt() {}
        var It = Ot.prototype
        Rt.prototype = function (t, e) {
            var n = new Rt()
            if (t instanceof Rt)
                t.each(function (t) {
                    n.add(t)
        ...
        function Gt() {
            ...
            return (
                (i.domain = function (n) {
                    ...
                    ;(e = []), (t = Ot())
                    for (var r, a, o = -1, l = n.length; ++o < l; ) t.has((a = (r = n[o]) + '')) || t.set(a, e.push(r))
                    return i
                }),
                (i.range = function (t) {
                    return arguments.length ? ((n = Ht.call(t)), i) : n.slice()
                }),
                (i.unknown = function (t) {
                    return arguments.length ? ((r = t), i) : r
                }),
                (i.copy = function () {
                    return Gt(e, n).unknown(r)
                }),
        ...
        var Xt = 0.7,
            ...
            $t = '\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
            Qt = /^#([0-9a-f]{3,8})$/,
            te = new RegExp('^rgb\\(' + [Jt, Jt, Jt] + '\\)$'),
            ee = new RegExp('^rgb\\(' + [$t, $t, $t] + '\\)$'),
            ne = new RegExp('^rgba\\(' + [Jt, Jt, Jt, Zt] + '\\)$'),
            re = new RegExp('^rgba\\(' + [$t, $t, $t, Zt] + '\\)$'),
            ie = new RegExp('^hsl\\(' + [Zt, $t, $t] + '\\)$'),
            ae = new RegExp('^hsla\\(' + [Zt, $t, $t, Zt] + '\\)$'),
            oe = {
                aliceblue: 15792383,
                ...
                (e = Qt.exec(t))
                    ? ((n = e[1].length),
                      ...
                      6 === n
                          ? ce(e)
                          : 3 === n
                          ? new de(((e >> 8) & 15) | ((e >> 4) & 240), ((e >> 4) & 15) | (240 & e), ((15 & e) << 4) | (15 & e), 1)
                          : 8 === n
                          ? fe((e >> 24) & 255, (e >> 16) & 255, (e >> 8) & 255, (255 & e) / 255)
                          : 4 === n
                          ? fe(
                                ((e >> 12) & 15) | ((e >> 8) & 240),
                                ((e >> 8) & 15) | ((e >> 4) & 240),
                          ...
                          : null)
                    : (e = te.exec(t))
                    ? new de(e[1], e[2], e[3], 1)
                    : (e = ee.exec(t))
                    ? new de((255 * e[1]) / 100, (255 * e[2]) / 100, (255 * e[3]) / 100, 1)
                    : (e = ne.exec(t))
                    ? fe(e[1], e[2], e[3], e[4])
                    : (e = re.exec(t))
                    ? fe((255 * e[1]) / 100, (255 * e[2]) / 100, (255 * e[3]) / 100, e[4])
                    : (e = ie.exec(t))
        ...
        function ce(t) {
            return new de((t >> 16) & 255, (t >> 8) & 255, 255 & t, 1)
        }
        function fe(t, e, n, r) {
            return r <= 0 && (t = e = n = NaN), new de(t, e, n, r)
        }
        function he(t) {
            return t instanceof Yt || (t = ue(t)), t ? new de((t = t.rgb()).r, t.g, t.b, t.opacity) : new de()
        }
        function pe(t, e, n, r) {
            return 1 === arguments.length ? he(t) : new de(t, e, n, null == r ? 1 : r)
        }
        function de(t, e, n, r) {
        ...
        function me(t) {
            ...
            if ((t instanceof Yt || (t = ue(t)), !t)) return new xe()
            ...
            return (
                l
                    ? ((o = e === a ? (n - r) / l + 6 * (n < r) : n === a ? (r - e) / l + 2 : (e - n) / l + 4),
                      (l /= s < 0.5 ? a + i : 2 - a - i),
                      (o *= 60))
                    : (l = s > 0 && s < 1 ? 0 : o),
                new xe(o, l, s, t.opacity)
            )
        }
        function xe(t, e, n, r) {
        ...
        qt(Yt, ue, {
            ...
            qt(
                ...
                Vt(Yt, {
                    brighter: function (t) {
                        return (t = null == t ? Kt : Math.pow(Kt, t)), new de(this.r * t, this.g * t, this.b * t, this.opacity)
                    },
                    darker: function (t) {
                        return (t = null == t ? Xt : Math.pow(Xt, t)), new de(this.r * t, this.g * t, this.b * t, this.opacity)
                    },
                    rgb: function () {
                        return this
                    },
            ...
            qt(
                ...
                Vt(Yt, {
                    brighter: function (t) {
                        return (t = null == t ? Kt : Math.pow(Kt, t)), new xe(this.h, this.s, this.l * t, this.opacity)
                    },
                    darker: function (t) {
                        return (t = null == t ? Xt : Math.pow(Xt, t)), new xe(this.h, this.s, this.l * t, this.opacity)
                    },
                    rgb: function () {
        ...
        function ze(t) {
            return function (e) {
                var n,
                    ...
                    o = new Array(i),
                    l = new Array(i)
                for (n = 0; n < i; ++n) (r = pe(e[n])), (a[n] = r.r || 0), (o[n] = r.g || 0), (l[n] = r.b || 0)
                return (
                    (a = t(a)),
                    (o = t(o)),
                    (l = t(l)),
        ...
        ze(function (t) {
            ...
            return function (n) {
                var r = Math.floor(((n %= 1) < 0 ? ++n : n) * e),
                    ...
                    o = t[(r + 1) % e],
                    l = t[(r + 2) % e]
                return Se((n - r / e) * e, i, a, o, l)
            }
        })
        var Le = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
            Ne = new RegExp(Le.source, 'g')
        function Pe(t, e) {
            var n,
                r,
                i,
                a = (Le.lastIndex = Ne.lastIndex = 0),
                o = -1,
                l = [],
                s = []
            for (t += '', e += ''; (n = Le.exec(t)) && (r = Ne.exec(e)); )
                (i = r.index) > a && ((i = e.slice(a, i)), l[o] ? (l[o] += i) : (l[++o] = i)),
                    (n = n[0]) === (r = r[0])
                        ? l[o]
                            ? (l[o] += r)
                            : (l[++o] = r)
                        : ((l[++o] = null), s.push({ i: o, x: Ce(n, r) })),
                    (a = Ne.lastIndex)
            return (
        ...
        function Ve() {
            var t,
                ...
                u = je
            function c() {
                return (r = Math.min(o.length, l.length) > 2 ? Ge : Be), (i = a = null), f
            }
            function f(e) {
                return isNaN((e = +e)) ? n : (i || (i = r(o.map(t), l, s)))(t(u(e)))
            }
            return (
                (f.invert = function (n) {
                    return u(e((a || (a = r(l, o.map(t), Ce)))(n)))
                }),
                (f.domain = function (t) {
                    return arguments.length ? ((o = jt.call(t, Ie)), u === je || (u = Ue(o)), c()) : o.slice()
                }),
                (f.range = function (t) {
                    return arguments.length ? ((l = Ht.call(t)), c()) : l.slice()
                }),
                (f.rangeRound = function (t) {
                    return (l = Ht.call(t)), (s = Re), c()
                }),
                (f.clamp = function (t) {
                    return arguments.length ? ((u = t ? Ue(o) : je), f) : u !== je
                }),
        ...
        var Xe,
            Ke = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i
        function Je(t) {
            if (!(e = Ke.exec(t))) throw new Error('invalid format: ' + t)
            var e
            return new Ze({
                fill: e[1],
                align: e[2],
        ...
        var en = {
            ...
            s: function (t, e) {
                ...
                var r = n[0],
                    i = n[1],
                    a = i - (Xe = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
                    o = r.length
                return a === o
                    ? r
                    : a > o
                    ...
                    : '0.' + new Array(1 - a).join('0') + $e(t, Math.max(0, e + a - 1))[0]
            },
            X: function (t) {
        ...
        var rn,
            an,
            on,
            ln = Array.prototype.map,
            sn = ['y', 'z', 'a', 'f', 'p', 'n', 'µ', 'm', '', 'k', 'M', 'G', 'T', 'P', 'E', 'Z', 'Y']
        function un(t) {
            return (
                (rn = (function (t) {
                    var e,
                        ...
                        r =
                            void 0 === t.grouping || void 0 === t.thousands
                                ? nn
                                : ((e = ln.call(t.grouping, Number)),
                                  (n = t.thousands + ''),
                                  function (t, r) {
                                      for (
                                          var i = t.length, a = [], o = 0, l = e[0], s = 0;
                                          i > 0 &&
                                          l > 0 &&
                    ...
                    function f(t) {
                        var e = (t = Je(t)).fill,
                            ...
                            y = t.trim,
                            v = t.type
                        'n' === v ? ((g = !0), (v = 'g')) : en[v] || (void 0 === _ && (_ = 12), (y = !0), (v = 'g')),
                            (p || ('0' === e && '=' === n)) && ((p = !0), (e = '0'), (n = '='))
                        ...
                        function w(t) {
                            ...
                            if ('c' === v) (w = b(t) + w), (t = '')
                                ...
                                if (
                                    ...
                                    T && 0 == +t && '+' !== f && (T = !1),
                                    (h = (T ? ('(' === f ? f : u) : '-' === f || '(' === f ? '' : f) + h),
                                    (w = ('s' === v ? sn[8 + Xe / 3] : '') + w + (T && '(' === f ? ')' : '')),
                                    S)
                                )
                                    for (i = -1, a = t.length; ++i < a; )
                                        if (48 > (s = t.charCodeAt(i)) || s > 57) {
                                            ;(w = (46 === s ? o + t.slice(i + 1) : t.slice(i)) + w), (t = t.slice(0, i))
                                            break
                                        }
                            }
                            g && !p && (t = r(t, 1 / 0))
                            var k = h.length + t.length + w.length,
                                z = k < d ? new Array(d - k + 1).join(e) : ''
                            switch ((g && p && ((t = r(z + t, z.length ? d - w.length : 1 / 0)), (z = '')), n)) {
                                case '<':
                                    t = h + t + w + z
                                    break
                                case '=':
                                    ...
                                    break
                                case '^':
                                    t = z.slice(0, (k = z.length >> 1)) + h + t + w + z.slice(k)
                                    break
                                default:
                                    t = z + h + t + w
                            }
                    ...
                    return {
                        ...
                        formatPrefix: function (t, e) {
                            var n = f((((t = Je(t)).type = 'f'), t)),
                                r = 3 * Math.max(-8, Math.min(8, Math.floor(Qe(e) / 3))),
                                i = Math.pow(10, -r),
                                a = sn[8 + r / 3]
                            return function (t) {
                                return n(i * t) + a
        ...
        function cn(t) {
            ...
            return (
                (t.ticks = function (t) {
                    var n = e()
                    return kt(n[0], n[n.length - 1], null == t ? 10 : t)
                }),
                        ...
                        var i,
                            a = (function (t, e, n) {
                                var r = Math.abs(e - t) / Math.max(0, n),
                                    ...
                                    a = r / i
                                return a >= St ? (i *= 10) : a >= wt ? (i *= 5) : a >= Tt && (i *= 2), e < t ? -i : i
                            })(t, e, n)
                        switch ((r = Je(null == r ? ',f' : r)).type) {
                            case 's':
                                    ...
                                    null != r.precision ||
                                        isNaN(
                                            (i = (function (t, e) {
                                                return Math.max(
                                                    0,
                                                    3 * Math.max(-8, Math.min(8, Math.floor(Qe(e) / 3))) - Qe(Math.abs(t))
                                                )
                                            })(a, o))
                                        ) ||
                                        (r.precision = i),
                ...
                (t.nice = function (n) {
                    ...
                    var r,
                        ...
                        s = i[o]
                    return (
                        s < l && ((r = l), (l = s), (s = r), (r = a), (a = o), (o = r)),
                        (r = zt(l, s, n)) > 0
                            ? (r = zt((l = Math.floor(l / r) * r), (s = Math.ceil(s / r) * r), n))
                            : r < 0 && (r = zt((l = Math.ceil(l * r) / r), (s = Math.floor(s * r) / r), n)),
                        r > 0
                            ? ((i[a] = Math.floor(l / r) * r), (i[o] = Math.ceil(s / r) * r), e(i))
                            : r < 0 && ((i[a] = Math.ceil(l * r) / r), (i[o] = Math.floor(s * r) / r), e(i)),
                        t
                    )
                }),
                t
        ...
        function vn(t) {
            ...
            function o() {
                return (
                    ...
                    i()[0] < 0 ? ((e = yn(e)), (n = yn(n)), t(dn, gn)) : t(hn, pn),
                    r
                )
            }
            return (
                ...
                (r.ticks = function (t) {
                    ...
                    if (!(a % 1) && p - h < d) {
                        if (((h = Math.round(h) - 1), (p = Math.round(p) + 1), l > 0)) {
                            ...
                            for (; h < p; ++h)
                                for (c = a - 1, u = n(h); c >= 1; --c)
                                    if (!((f = u * c) < l)) {
                                        if (f > s) break
                                        g.push(f)
                                    }
                    } else g = kt(h, p, Math.min(p - h, d)).map(n)
                    return r ? g.reverse() : g
                }),
                (r.tickFormat = function (t, i) {
                    if ((null == i && (i = 10 === a ? '.0e' : ','), 'function' != typeof i && (i = an(i)), t === 1 / 0)) return i
                    null == t && (t = 10)
        ...
        function mn() {
            var t = vn(Ve()).domain([1, 10])
            return (
                (t.copy = function () {
                    return qe(t, mn()).base(t.base())
                }),
                Ut.apply(t, arguments),
                t
            )
        ...
        function wn(t) {
            var e = t(je, je),
                n = 1
            function r() {
                return 1 === n ? t(je, je) : 0.5 === n ? t(bn, Sn) : t(xn(n), xn(1 / n))
            }
            return (
        ...
        function zn() {
            ...
            function i() {
                ...
                for (r = new Array(i - 1); ++t < i; ) r[t - 1] = Et(e, t / i)
                return a
            }
            function a(e) {
                return isNaN((e = +e)) ? t : n[mt(r, e)]
            }
            return (
                ...
                (a.copy = function () {
                    return zn().domain(e).range(n).unknown(t)
                }),
        ...
        function Fn() {
            ...
            return (
                ...
                (o.range = function (t) {
                    return arguments.length ? ((r = (a = Ht.call(t)).length - 1), l()) : a.slice()
                }),
                ...
                (o.copy = function () {
                    return Fn().domain([e, n]).range(a).unknown(t)
                }),
                Ut.apply(cn(o), arguments)
            )
        }
        function An() {
            var t,
                ...
                r = 1
            function i(i) {
                return i <= i ? n[mt(e, i, 0, r)] : t
            }
            return (
                (i.domain = function (t) {
                    return arguments.length ? ((e = Ht.call(t)), (r = Math.min(e.length, n.length - 1)), i) : e.slice()
                }),
                (i.range = function (t) {
                    return arguments.length ? ((n = Ht.call(t)), (r = Math.min(e.length, n.length - 1)), i) : n.slice()
                }),
                ...
                (i.copy = function () {
                    return An().domain(e).range(n).unknown(t)
                }),
                Ut.apply(i, arguments)
            )
        }
        ...
        un({ decimal: '.', thousands: ',', grouping: [3], currency: ['$', ''], minus: '-' })
        var En = Cn(
                new Array(3)
                    .concat(
                        'fff7bcfec44fd95f0e',
        ...
        function On(t, e) {
            return fetch(t, e).then(Dn)
        }
        var Rn = { value: function () {} }
        function In() {
        ...
        function jn(t, e) {
            return t
                ...
                .map(function (t) {
                    var n = '',
                        r = t.indexOf('.')
                    if ((r >= 0 && ((n = t.slice(r + 1)), (t = t.slice(0, r))), t && !e.hasOwnProperty(t)))
        ...
        Wn.prototype = In.prototype = {
            ...
            on: function (t, e) {
                ...
                if (!(arguments.length < 2)) {
                    ...
                    for (; ++a < o; )
                        if ((n = (t = i[a]).type)) r[n] = Un(r[n], t.name, e)
                        else if (null == e) for (n in r) r[n] = Un(r[n], t.name, null)
                    return this
                }
                for (; ++a < o; ) if ((n = (t = i[a]).type) && (n = Hn(r[n], t.name))) return n
            },
            copy: function () {
                var t = {},
                    e = this._
        ...
        function qn(t) {
            var e = t.document.documentElement,
                n = dt(t).on('dragstart.drag', Gn, !0)
            'onselectstart' in e
                ? n.on('selectstart.drag', Gn, !0)
        ...
        function Kn(t, e) {
            ...
            if (h < 1e-12)
                (r = Math.log(u / o) / Yn),
                    (n = function (t) {
                        return [i + t * c, a + t * f, o * Math.exp(Yn * t * r)]
                    })
            else {
                var p = Math.sqrt(h),
                    d = (u * u - o * o + 4 * h) / (2 * o * 2 * p),
                    g = (u * u - o * o - 4 * h) / (2 * u * 2 * p),
                ...
                ;(r = (y - _) / Yn),
                    (n = function (t) {
                        var e,
                            ...
                            s =
                                (o / (2 * p)) *
                                (l * ((e = Yn * n + _), ((e = Math.exp(2 * e)) - 1) / (e + 1)) -
                                    (function (t) {
                                        return ((t = Math.exp(t)) - 1 / t) / 2
                                    })(_))
                        return [i + s * c, a + s * f, (o * l) / Xn(Yn * n + _)]
                    })
            }
            return (n.duration = 1e3 * r), n
        }
        function Jn() {
            for (var t, e = et; (t = e.sourceEvent); ) e = t
            return e
        }
        function Zn(t, e) {
        ...
        function $n(t) {
            var e = Jn()
            return e.changedTouches && (e = e.changedTouches[0]), Zn(t, e)
        }
        function Qn(t, e, n) {
            arguments.length < 3 && ((n = e), (e = Jn().changedTouches))
            for (var r, i = 0, a = e ? e.length : 0; i < a; ++i) if ((r = e[i]).identifier === n) return Zn(t, r)
            return null
        }
        var tr,
            er,
            ...
            or = 0,
            lr = 0,
            sr = 'object' == typeof performance && performance.now ? performance : Date,
            ur =
        ...
        function dr() {
            ;(or = (ar = sr.now()) + lr), (nr = rr = 0)
            try {
                !(function () {
                    cr(), ++nr
                    for (var t, e = tr; e; ) (t = or - e._time) >= 0 && e._call.call(null, t), (e = e._next)
                    --nr
                })()
            } finally {
                ;(nr = 0),
                    (function () {
                        for (var t, e, n = tr, r = 1 / 0; n; )
                            n._call
                                ? (r > n._time && (r = n._time), (t = n), (n = n._next))
                                : ((e = n._next), (n._next = null), (n = t ? (t._next = e) : (tr = e)))
                        ;(er = t), _r(r)
                    })(),
                    (or = 0)
            }
        ...
        function _r(t) {
            nr ||
                ...
                t - or > 24
                    ? (t < 1 / 0 && (rr = setTimeout(dr, t - sr.now() - lr)), ir && (ir = clearInterval(ir)))
                    : (ir || ((ar = sr.now()), (ir = setInterval(gr, 1e3))), (nr = 1), ur(dr)))
        }
        function yr(t, e, n) {
            var r = new hr()
            return (
        ...
        hr.prototype = pr.prototype = {
            ...
            restart: function (t, e, n) {
                ...
                ;(n = (null == n ? cr() : +n) + (null == e ? 0 : +e)),
                    this._next || er === this || (er ? (er._next = this) : (tr = this), (er = this)),
                    (this._call = t),
                    (this._time = n),
                    _r()
            },
        ...
        var vr = Bn('start', 'end', 'cancel', 'interrupt'),
            mr = []
                ...
                function a(s) {
                    ...
                    if (
                        ...
                        for (n.state = 3, r = new Array((f = n.tween.length)), u = 0, c = -1; u < f; ++u)
                            (h = n.tween[u].value.call(t, t.__data__, n.index, n.group)) && (r[++c] = h)
                        r.length = c + 1
                    }
                }
                function o(e) {
                    for (
                        var i = e < n.duration ? n.ease.call(null, e / n.duration) : (n.timer.restart(l), (n.state = 5), 1),
                            a = -1,
                            o = r.length;
                        ++a < o;
        ...
        var kr,
            ...
            Ar,
            Mr = 180 / Math.PI,
            Cr = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 }
        function Er(t, e, n, r, i, a) {
            ...
            return (
                ...
                { translateX: i, translateY: a, rotate: Math.atan2(e, t) * Mr, skewX: Math.atan(s) * Mr, scaleX: o, scaleY: l }
            )
        }
        function Lr(t, e, n, r) {
            function i(t) {
        ...
        var Nr = Lr(
                function (t) {
                    return 'none' === t
                        ...
                        : (kr ||
                              ...
                              (Fr = document.defaultView)),
                          (kr.style.transform = t),
                          (t = Fr.getComputedStyle(zr.appendChild(kr), null).getPropertyValue('transform')),
                          zr.removeChild(kr),
                          Er(+(t = t.slice(7, -1).split(','))[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
                },
                'px, ',
                'px)',
                'deg)'
            ...
            Pr = Lr(
                function (t) {
                    return null == t
                        ? Cr
                        : (Ar || (Ar = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
                          Ar.setAttribute('transform', t),
                          (t = Ar.transform.baseVal.consolidate()) ? Er((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : Cr)
                },
                ', ',
                ')',
                ')'
        ...
        function Ir(t, e) {
            var n
            return ('number' == typeof e ? Ce : e instanceof ue ? ke : (n = ue(e)) ? ((e = n), ke) : Pe)(t, e)
        }
        function Wr(t) {
            return function () {
                this.removeAttribute(t)
        ...
        function Xr(t, e) {
            ...
            function i() {
                var i = e.apply(this, arguments)
                return i !== r && (n = (r = i) && qr(t, i)), n
            }
            return (i._value = e), i
        }
        function Kr(t, e) {
            return function () {
                br(this, t).delay = +e.apply(this, arguments)
            }
        }
        function Jr(t, e) {
            return (
        ...
        var ei = pt.prototype.constructor
        function ni(t) {
            return function () {
                this.style.removeProperty(t)
            }
        ...
        si.prototype = function (t) {
            ...
            select: function (t) {
                ...
                for (var r = this._groups, i = r.length, o = new Array(i), l = 0; l < i; ++l)
                    for (var s, u, c = r[l], f = c.length, h = (o[l] = new Array(f)), p = 0; p < f; ++p)
                        (s = c[p]) &&
                            (u = t.call(s, s.__data__, p, c)) &&
                            ('__data__' in s && (u.__data__ = s.__data__), (h[p] = u), xr(h[p], e, n, p, h, wr(s, n)))
                return new si(o, this._parents, e, n)
            },
            selectAll: function (t) {
                var e = this._name,
                    n = this._id
                ...
                for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s)
                    for (var u, c = r[s], f = c.length, h = 0; h < f; ++h)
                        if ((u = c[h])) {
                            for (var p, d = t.call(u, u.__data__, h, c), g = wr(u, n), _ = 0, y = d.length; _ < y; ++_)
                                (p = d[_]) && xr(p, e, n, _, d, g)
                            a.push(d), o.push(u)
                        }
                return new si(a, o, e, n)
            },
            filter: function (t) {
                'function' != typeof t && (t = s(t))
                for (var e = this._groups, n = e.length, r = new Array(n), i = 0; i < n; ++i)
            ...
            merge: function (t) {
                ...
                for (
                    ...
                    for (var s, u = e[l], c = n[l], f = u.length, h = (o[l] = new Array(f)), p = 0; p < f; ++p)
                        (s = u[p] || c[p]) && (h[p] = s)
                for (; l < r; ++l) o[l] = e[l]
                return new si(o, this._parents, this._name, this._id)
            },
            selection: function () {
            ...
            on: function (t, e) {
                var n = this._id
                return arguments.length < 2 ? wr(this.node(), n).on.on(t) : this.each(ti(n, t, e))
            },
            attr: function (t, e) {
                var n = _(t),
                    r = 'transform' === n ? Pr : Ir
                return this.attrTween(
                    t,
                    'function' == typeof e
                        ? (n.local ? Gr : Br)(n, r, Rr(this, 'attr.' + t, e))
                        : null == e
                        ? (n.local ? jr : Wr)(n)
                        : (n.local ? Ur : Hr)(n, r, e)
                )
            ...
            attrTween: function (t, e) {
                ...
                if ('function' != typeof e) throw new Error()
                var r = _(t)
                return this.tween(n, (r.local ? Yr : Xr)(r, e))
            },
            style: function (t, e, n) {
                var r = 'transform' == (t += '') ? Nr : Ir
                return null == e
                    ? this.styleTween(
                          t,
                          (function (t, e) {
                              ...
                              return function () {
                                  var a = F(this, t),
                                      o = (this.style.removeProperty(t), F(this, t))
                          ...
                          (function (t, e, n) {
                              ...
                              return function () {
                                  var o = F(this, t),
                                      ...
                                      s = l + ''
                                  return (
                                      null == l && (this.style.removeProperty(t), (s = l = F(this, t))),
                                      o === s ? null : o === r && s === i ? a : ((i = s), (a = e((r = o), l)))
                                  )
                              }
                          })(t, r, Rr(this, 'style.' + t, e))
                      ).each(
                          (function (t, e) {
                              var n,
                                  r,
                              ...
                              return function () {
                                  var s = Sr(this, t),
                                      u = s.on,
                                      c = null == s.value[o] ? a || (a = ni(e)) : void 0
            ...
            styleTween: function (t, e, n) {
                ...
                if ('function' != typeof e) throw new Error()
                return this.tween(r, ii(t, e, null == n ? '' : n))
            },
            text: function (t) {
                return this.tween(
                    'text',
            ...
            tween: function (t, e) {
                ...
                if (((t += ''), arguments.length < 2)) {
                    for (var r, i = wr(this.node(), n).tween, a = 0, o = i.length; a < o; ++a)
                        if ((r = i[a]).name === t) return r.value
                    return null
                }
                return this.each((null == e ? Dr : Or)(n, t, e))
            },
            delay: function (t) {
                var e = this._id
                return arguments.length ? this.each(('function' == typeof t ? Kr : Jr)(e, t)) : wr(this.node(), e).delay
            },
            duration: function (t) {
                var e = this._id
                return arguments.length ? this.each(('function' == typeof t ? Zr : $r)(e, t)) : wr(this.node(), e).duration
            },
            ease: function (t) {
                var e = this._id
                return arguments.length ? this.each(Qr(e, t)) : wr(this.node(), e).ease
            },
            end: function () {
                var t,
                    e,
        ...
        function hi(t, e) {
            for (var n; !(n = t.__transition) || !(n = n[e]); ) if (!(t = t.parentNode)) return (fi.time = cr()), fi
            return n
        }
        function pi(t) {
            return function () {
        ...
        ;(pt.prototype.interrupt = function (t) {
            ...
            (pt.prototype.transition = function (t) {
                ...
                t instanceof si
                    ? ((e = t._id), (t = t._name))
                    : ((e = ui()), ((n = fi).time = cr()), (t = null == t ? null : t + ''))
                for (var r = this._groups, i = r.length, a = 0; a < i; ++a)
                    for (var o, l = r[a], s = l.length, u = 0; u < s; ++u) (o = l[u]) && xr(o, t, e, u, l, n || hi(o, e))
        ...
        function wi() {
            return -et.deltaY * (1 === et.deltaMode ? 0.05 : et.deltaMode ? 1 : 0.002)
        }
        function Ti() {
        ...
        var Fi = 1e-6,
            ...
            Ri = Math.cos,
            Ii = Math.ceil,
            Wi = (Math.exp, Math.floor, Math.log, Math.pow, Math.sin),
            ji =
                Math.sign ||
                function (t) {
        ...
        function qi(t, e) {
            return Pi(t[0] - e[0]) < Fi && Pi(t[1] - e[1]) < Fi
        }
        function Vi(t, e, n, r) {
            ...
            if (
                (t.forEach(function (t) {
                    if (!((e = t.length - 1) <= 0)) {
                        ...
                        l.push((n = new Vi(r, t, null, !0))),
                            s.push((n.o = new Vi(r, null, n, !1))),
                            l.push((n = new Vi(o, t, null, !1))),
                            s.push((n.o = new Vi(o, null, n, !0)))
                    }
                }),
                l.length)
            ) {
                for (s.sort(e), Xi(l), Xi(s), a = 0, o = s.length; a < o; ++a) s[a].e = n = !n
                for (var u, c, f = l[0]; ; ) {
                    for (var h = f, p = !0; h.v; ) if ((h = h.n) === f) return
                    ;(u = h.z), i.lineStart()
                    do {
                        if (((h.v = h.o.v = !0), h.e)) {
                            if (p) for (a = 0, o = u.length; a < o; ++a) i.point((c = u[a])[0], c[1])
                            else r(h.x, h.n.x, 1, i)
                            h = h.n
                        } else {
                            if (p) for (u = h.p.z, a = u.length - 1; a >= 0; --a) i.point((c = u[a])[0], c[1])
        ...
        function Zi(t, e, n, r) {
            ...
            function a(i, a, l, u) {
                var c = 0,
                    f = 0
                if (null == i || (c = o(i, l)) !== (f = o(a, l)) || (s(i, a) < 0) ^ (l > 0))
                    do {
            ...
            return function (o) {
                var s,
                    ...
                    b = {
                        ...
                        lineEnd: function () {
                            s && (w(f, h), p && _ && x.rejoin(), s.push(x.result())), (b.point = S), _ && m.lineEnd()
                        },
                        ...
                        polygonEnd: function () {
                            var e = (function () {
                                    for (var e = 0, n = 0, i = u.length; n < i; ++n)
                                        for (var a, o, l = u[n], s = 1, c = l.length, f = l[0], h = f[0], p = f[1]; s < c; ++s)
                                            (a = h),
                                                (o = p),
                                                (h = (f = l[s])[0]),
                                                (p = f[1]),
                                                o <= r
                                                    ? p > r && (h - a) * (r - o) > (p - o) * (t - a) && ++e
                                                    : p <= r && (h - a) * (r - o) < (p - o) * (t - a) && --e
                                    return e
                                })(),
                                n = v && e,
                ...
                function w(a, o) {
                    var l = i(a, o)
                    if ((u && c.push([a, o]), y)) (f = a), (h = o), (p = l), (y = !1), l && (m.lineStart(), m.point(a, o))
                    else if (l && _) m.point(a, o)
                    else {
                        var s = [(d = Math.max(Ji, Math.min(Ki, d))), (g = Math.max(Ji, Math.min(Ki, g)))],
                            x = [(a = Math.max(Ji, Math.min(Ki, a))), (o = Math.max(Ji, Math.min(Ki, o)))]
                        !(function (t, e, n, r, i, a) {
                                ...
                                if (((o = i - l), f || !(o < 0))) {
                                    ...
                                    if (((o = r - s), h || !(o > 0))) {
                                        ...
                                        if (((o = a - s), h || !(o < 0))) {
                                            ...
                                            return (
                                                u > 0 && ((t[0] = l + u * f), (t[1] = s + u * h)),
                                                c < 1 && ((e[0] = l + c * f), (e[1] = s + c * h)),
                                                !0
                                            )
                                        }
                                    }
                            ...
                            ? l && (m.lineStart(), m.point(a, o), (v = !1))
                            : (_ || (m.lineStart(), m.point(s[0], s[1])), m.point(x[0], x[1]), l || m.lineEnd(), (v = !1))
                    }
                    ;(d = a), (g = o), (_ = l)
                }
                return b
        ...
        function ta() {}
        function ea(t, e) {
            t && ra.hasOwnProperty(t.type) && ra[t.type](t, e)
        }
        ta.prototype = {
            constructor: ta,
            point: function (t, e) {
        ...
        var na = {
                ...
                FeatureCollection: function (t, e) {
                    for (var n = t.features, r = -1, i = n.length; ++r < i; ) ea(n[r].geometry, e)
                },
            },
            ra = {
                Sphere: function (t, e) {
                ...
                LineString: function (t, e) {
                    ia(t.coordinates, e, 0)
                },
                MultiLineString: function (t, e) {
                    for (var n = t.coordinates, r = -1, i = n.length; ++r < i; ) ia(n[r], e, 0)
                },
                Polygon: function (t, e) {
                    aa(t.coordinates, e)
                },
                MultiPolygon: function (t, e) {
                    for (var n = t.coordinates, r = -1, i = n.length; ++r < i; ) aa(n[r], e)
                },
                GeometryCollection: function (t, e) {
                    for (var n = t.geometries, r = -1, i = n.length; ++r < i; ) ea(n[r], e)
                },
            }
        function ia(t, e, n) {
            var r,
        ...
        function aa(t, e) {
            var n = -1,
                r = t.length
            for (e.polygonStart(); ++n < r; ) ia(t[n], e, 1)
            e.polygonEnd()
        }
        function oa(t, e) {
            t && na.hasOwnProperty(t.type) ? na[t.type](t, e) : ea(t, e)
        }
        var la = 1 / 0,
            sa = la,
            ua = -la,
            ...
            fa = {
                point: function (t, e) {
                    t < la && (la = t), t > ua && (ua = t), e < sa && (sa = e), e > ca && (ca = e)
                },
                lineStart: Bi,
                lineEnd: Bi,
                polygonStart: Bi,
            ...
            return pa(
                ...
                function (n) {
                    var r = e[1][0] - e[0][0],
                        ...
                        l = +e[0][1] + (i - a * (n[1][1] + n[0][1])) / 2
                    t.scale(150 * a).translate([o, l])
                },
                n
            )
        }
        ...
        ma.prototype = {
            ...
            add: function (t) {
                ba(xa, t, this.t), ba(this, xa.s, this.s), this.s ? (this.t += xa.t) : (this.s = xa.t)
            },
            valueOf: function () {
                return this.s
            },
        ...
        var Sa,
            ...
            Aa = {
                ...
                lineEnd: Bi,
                polygonStart: function () {
                    ;(Aa.lineStart = Ma), (Aa.lineEnd = La)
                },
                polygonEnd: function () {
                    ;(Aa.lineStart = Aa.lineEnd = Aa.point = Bi), za.add(Pi(Fa)), Fa.reset()
                },
                result: function () {
                    var t = za / 2
                    return za.reset(), t
        ...
        function Ca(t, e) {
            ;(Aa.point = Ea), (Sa = Ta = t), (wa = ka = e)
        }
        function Ea(t, e) {
            Fa.add(ka * t - Ta * e), (Ta = t), (ka = e)
        }
        function La() {
            Ea(Sa, wa)
        }
        var Na,
            ...
            Ya = {
                ...
                lineEnd: $a,
                polygonStart: function () {
                    ;(Ya.lineStart = Qa), (Ya.lineEnd = to)
                },
                polygonEnd: function () {
                    ;(Ya.point = Xa), (Ya.lineStart = Ka), (Ya.lineEnd = $a)
                },
                result: function () {
                    var t = Va ? [Ga / Va, qa / Va] : Ba ? [Ha / Ba, Ua / Ba] : ja ? [Ia / ja, Wa / ja] : [NaN, NaN]
                    return (Ia = Wa = ja = Ha = Ua = Ba = Ga = qa = Va = 0), t
                },
            }
        function Xa(t, e) {
            ;(Ia += t), (Wa += e), ++ja
        ...
        function Ja(t, e) {
            ;(Ya.point = Za), Xa((Da = t), (Oa = e))
        }
        function Za(t, e) {
            var n = t - Da,
                r = e - Oa,
                i = Hi(n * n + r * r)
            ;(Ha += (i * (Da + t)) / 2), (Ua += (i * (Oa + e)) / 2), (Ba += i), Xa((Da = t), (Oa = e))
        }
        function $a() {
            Ya.point = Xa
        }
        ...
        function eo(t, e) {
            ;(Ya.point = no), Xa((Na = Da = t), (Pa = Oa = e))
        }
        function no(t, e) {
            var n = t - Da,
                r = e - Oa,
            ...
            point: function (t, e) {
                switch (this._point) {
                    ...
                    case 1:
                        ...
                        break
                    default:
                        this._context.moveTo(t + this._radius, e), this._context.arc(t, e, this._radius, 0, Ei)
                }
            },
            result: Bi,
        }
        ...
        function ho(t, e) {
            ;(fo.point = po), (oo = so = t), (lo = uo = e)
        }
        function po(t, e) {
            ;(so -= t), (uo -= e), co.add(Hi(so * so + uo * uo)), (so = t), (uo = e)
        }
        var go,
            _o,
            yo,
        ...
        function Oo() {
            ...
            function v() {
                return Lt(Ii(r / d) * d, n, d)
                    .map(c)
                    .concat(Lt(Ii(l / g) * g, o, g).map(f))
                    .concat(
                        Lt(Ii(e / h) * h, t, h)
                            .filter(function (t) {
                                return Pi(t % d) > Fi
            ...
            return (
                ...
                (y.outline = function () {
                    return {
                        type: 'Polygon',
                        coordinates: [c(r).concat(f(o).slice(1), c(n).reverse().slice(1), f(l).reverse().slice(1))],
                    }
                }),
                (y.extent = function (t) {
                ...
                (y.stepMinor = function (t) {
                    return arguments.length ? ((h = +t[0]), (p = +t[1]), y) : [h, p]
                }),
                (y.precision = function (h) {
                    return arguments.length
                        ? ((_ = +h), (s = Po(a, i, 90)), (u = Do(e, t, _)), (c = Po(l, o, 90)), (f = Do(r, n, _)), y)
                        : _
                }),
                y
                    .extentMajor([
            ...
            point: function (t, e) {
                switch (this._point) {
                    ...
                    case 1:
                        ...
                        break
                    default:
                        null == this._circle && (this._circle = No(this._radius)), this._string.push('M', t, ',', e, this._circle)
                }
            },
            result: function () {
        ...
        var Ro = {
            ...
            lineEnd: Bo,
            polygonStart: function () {
                ;(Ro.lineStart = Go), (Ro.lineEnd = qo)
            },
            polygonEnd: function () {
                ;(Ro.lineStart = jo), (Ro.lineEnd = Bo)
            },
        }
        function Io(t, e) {
            t *= Ni
            var n = Ri((e *= Ni))
            Wo(n * Ri(t), n * Wi(t), Wi(e))
        }
        function Wo(t, e, n) {
            ++go, (yo += (t - yo) / go), (vo += (e - vo) / go), (mo += (n - mo) / go)
        }
        function jo() {
            Ro.point = Ho
        }
        function Ho(t, e) {
            t *= Ni
            var n = Ri((e *= Ni))
            ;(Ao = n * Ri(t)), (Mo = n * Wi(t)), (Co = Wi(e)), (Ro.point = Uo), Wo(Ao, Mo, Co)
        }
        function Uo(t, e) {
            t *= Ni
            var n = Ri((e *= Ni)),
                ...
                a = Wi(e),
                o = Oi(
                    Hi((o = Mo * a - Co * i) * o + (o = Co * r - Ao * a) * o + (o = Ao * i - Mo * r) * o),
                    Ao * r + Mo * i + Co * a
                )
            ;(_o += o), (xo += o * (Ao + (Ao = r))), (bo += o * (Mo + (Mo = i))), (So += o * (Co + (Co = a))), Wo(Ao, Mo, Co)
        }
        function Bo() {
            Ro.point = Io
        }
        ...
        function qo() {
            Yo(zo, Fo), (Ro.point = Io)
        }
        function Vo(t, e) {
            ;(zo = t), (Fo = e), (t *= Ni), (e *= Ni), (Ro.point = Yo)
            var n = Ri(e)
            ;(Ao = n * Ri(t)), (Mo = n * Wi(t)), (Co = Wi(e)), Wo(Ao, Mo, Co)
        }
        function Yo(t, e) {
            t *= Ni
            var n = Ri((e *= Ni)),
        ...
        function Xo(t) {
            ;(go = _o = yo = vo = mo = xo = bo = So = wo = To = ko = 0), oa(t, Ro)
            var e = wo,
                n = To,
                r = ko,
                i = e * e + n * n + r * r
            return i < 1e-12 &&
                ((e = xo), (n = bo), (r = So), _o < Fi && ((e = yo), (n = vo), (r = mo)), (i = e * e + n * n + r * r) < 1e-12)
                ? [NaN, NaN]
                : [Oi(n, e) * Li, Ui(r / Hi(i)) * Li]
        }
        function Ko(t) {
            return [Oi(t[1], t[0]), Ui(t[2])]
        }
        function Jo(t) {
            var e = t[0],
                n = t[1],
                r = Ri(n)
            return [r * Ri(e), r * Wi(e), Wi(n)]
        }
        function Zo(t, e) {
        ...
        function el(t) {
            var e = Hi(t[0] * t[0] + t[1] * t[1] + t[2] * t[2])
            ;(t[0] /= e), (t[1] /= e), (t[2] /= e)
        }
        var nl = va()
        function rl(t) {
            return Pi(t[0]) <= Ai ? t[0] : ji(t[0]) * (((Pi(t[0]) + Ai) % Ei) - Ai)
        }
        function il(t, e, n, r) {
            return function (i) {
                var a,
                    ...
                    h = {
                        ...
                        lineEnd: _,
                        polygonStart: function () {
                            ;(h.point = y), (h.lineStart = v), (h.lineEnd = m), (o = []), (a = [])
                        },
                        polygonEnd: function () {
                            ;(h.point = p), (h.lineStart = g), (h.lineEnd = _), (o = At(o))
                            var t = (function (t, e) {
                                var n = rl(e),
                                    r = e[1],
                                    i = Wi(r),
                                    ...
                                    o = 0,
                                    l = 0
                                nl.reset(), 1 === i ? (r = Mi + Fi) : -1 === i && (r = -Mi - Fi)
                                for (var s = 0, u = t.length; s < u; ++s)
                                    if ((f = (c = t[s]).length))
                                        for (
                                            var c, f, h = c[f - 1], p = rl(h), d = h[1] / 2 + Ci, g = Wi(d), _ = Ri(d), y = 0;
                                            y < f;
                                            ++y, p = m, g = b, _ = S, h = v
                                        ) {
                                            var v = c[y],
                                            ...
                                            if (
                                                ...
                                                var M = $o(a, A)
                                                el(M)
                                                var C = (z ^ (w >= 0) ? -1 : 1) * Ui(M[2])
                                                ;(r > C || (r === C && (A[0] || A[1]))) && (l += z ^ (w >= 0) ? 1 : -1)
                                            }
                                        }
                                return (o < -1e-6 || (o < Fi && nl < -1e-6)) ^ (1 & l)
                            })(a, r)
                            o.length
                                ? (f || (i.polygonStart(), (f = !0)), Yi(o, ol, t, n, i))
                    ...
                    if ((l.pop(), a.push(l), (l = null), p))
                        if (1 & s) {
                            if ((e = (n = h[0]).length - 1) > 0) {
                                for (f || (i.polygonStart(), (f = !0)), i.lineStart(), t = 0; t < e; ++t)
                                    i.point((r = n[t])[0], r[1])
                                i.lineEnd()
                            }
                        } else p > 1 && 2 & s && h.push(h.pop().concat(h.shift())), o.push(h.filter(al))
                }
                return h
            }
        }
        ...
        function ol(t, e) {
            return ((t = t.x)[0] < 0 ? t[1] - Mi - Fi : Mi - t[1]) - ((e = e.x)[0] < 0 ? e[1] - Mi - Fi : Mi - e[1])
        }
        var ll = il(
            function () {
                return !0
                            ...
                            : i !== l &&
                              ...
                              (r = (function (t, e, n, r) {
                                  var i,
                                      ...
                                      o = Wi(t - n)
                                  return Pi(o) > Fi
                                      ? Di((Wi(e) * (a = Ri(r)) * Wi(n) - Wi(r) * (i = Ri(e)) * Wi(t)) / (i * a * o))
                                      : (e + r) / 2
                              })(n, r, a, o)),
                              t.point(i, r),
                              t.lineEnd(),
        ...
        function sl(t, e) {
            ;((e = Jo(e))[0] -= t), el(e)
            var n,
                r = (n = -e[1]) > 1 ? 0 : n < -1 ? Ai : Math.acos(n)
            return ((-e[2] < 0 ? -r : r) + Ei - Fi) % Ei
        }
        function ul(t) {
            var e = Ri(t),
                n = 6 * Ni,
            ...
            function o(t, n, r) {
                ...
                if (!(_ < 0)) {
                    ...
                    if (
                        ...
                        k || T < Fi
                            ? k
                                ? (S + w > 0) ^ (v[1] < (Pi(v[0] - x) < Fi ? S : w))
                                : S <= v[1] && v[1] <= w
                            : (T > Ai) ^ (x <= v[0] && v[0] <= b))
                    ) {
                        var z = tl(p, (-d + y) / g)
                        return Qo(z, h), [v, Ko(z)]
                    }
                }
            }
            function l(e, n) {
                    ...
                    return {
                        ...
                        point: function (f, h) {
                            var p,
                                d = [f, h],
                                g = a(f, h),
                                _ = r ? (g ? 0 : l(f, h)) : g ? l(f + (f < 0 ? Ai : -Ai), h) : 0
                            if (
                                (!e && (u = s = g) && t.lineStart(),
                                g !== s && (!(p = o(e, d)) || qi(e, p) || qi(d, p)) && (d[2] = 1),
                                g !== s)
                            )
                                (c = 0),
                                    g
                                        ? (t.lineStart(), (p = o(d, e)), t.point(p[0], p[1]))
                                        : ((p = o(e, d)), t.point(p[0], p[1], 2), t.lineEnd()),
                                    (e = p)
                            else if (i && e && r ^ g) {
                                var y
                                _ & n ||
                                    ...
                                    r
                                        ...
                                        : (t.point(y[1][0], y[1][1]), t.lineEnd(), t.lineStart(), t.point(y[0][0], y[0][1], 3)))
                            }
                            !g || (e && qi(e, d)) || t.point(d[0], d[1]), (e = d), (s = g), (n = _)
                        },
                        lineEnd: function () {
                            s && t.lineEnd(), (e = null)
                        },
                ...
                function (e, r, i, a) {
                    !(function (t, e, n, r, i, a) {
                        if (n) {
                            ...
                            null == i
                                ? ((i = e + r * Ei), (a = e - s / 2))
                                : ((i = sl(o, i)), (a = sl(o, a)), (r > 0 ? i < a : i > a) && (i += r * Ei))
                            for (var u, c = i; r > 0 ? c > a : c < a; c -= s)
                                (u = Ko([o, -l * Ri(c), -l * Wi(c)])), t.point(u[0], u[1])
                        }
                    })(a, t, n, i, e, r)
                },
                r ? [0, -t] : [-Ai, t - Ai]
        ...
        function fl(t, e) {
            return [Pi(t) > Ai ? t + Math.round(-t / Ei) * Ei : t, e]
        }
        function hl(t) {
            return function (e, n) {
                return [(e += t) > Ai ? e - Ei : e < -Ai ? e + Ei : e, n]
            }
        }
        function pl(t) {
            var e = hl(t)
            return (e.invert = hl(-t)), e
        }
        function dl(t, e) {
            var n = Ri(t),
                r = Wi(t),
            ...
            function o(t, e) {
                var o = Ri(e),
                    ...
                    u = Wi(e),
                    c = u * n + l * r
                return [Oi(s * i - c * a, l * n - u * r), Ui(c * i + s * a)]
            }
            return (
                (o.invert = function (t, e) {
                    var o = Ri(e),
                        ...
                        u = Wi(e),
                        c = u * i - s * a
                    return [Oi(s * i + u * a, l * n + c * r), Ui(c * n - l * r)]
                }),
                o
            )
        }
        ...
        function _l(t, e) {
            return +e
                ? (function (t, e) {
                      function n(r, i, a, o, l, s, u, c, f, h, p, d, g, _) {
                          var y = u - r,
                              v = c - i,
                              m = y * y + v * v
                          if (m > 4 * e && g--) {
                              var x = o + h,
                                  ...
                                  w = Hi(x * x + b * b + S * S),
                                  T = Ui((S /= w)),
                                  k = Pi(Pi(S) - 1) < Fi || Pi(a - f) < Fi ? (a + f) / 2 : Oi(b, x),
                                  z = t(k, T),
                                  F = z[0],
                                  A = z[1],
                                  M = F - r,
                                  C = A - i,
                                  E = v * M - y * C
                              ;((E * E) / m > e || Pi((y * M + v * C) / m - 0.5) > 0.3 || o * h + l * p + s * d < gl) &&
                                  (n(r, i, a, o, l, s, F, A, k, (x /= w), (b /= w), S, g, _),
                                  _.point(F, A),
                                  n(F, A, k, x, b, S, u, c, f, h, p, d, g, _))
                          }
                      }
                      return function (e) {
                          var r,
                          ...
                          function v(r, i) {
                              var a = Jo([r, i]),
                                  o = t(r, i)
                              n(c, f, u, h, p, d, (c = o[0]), (f = o[1]), (u = r), (h = a[0]), (p = a[1]), (d = a[2]), 16, e),
                                  e.point(c, f)
                          }
                          function m() {
                              ;(g.point = _), e.lineEnd()
                          ...
                          function b(t, e) {
                              v((r = t), e), (i = c), (a = f), (o = h), (l = p), (s = d), (g.point = v)
                          }
                          function S() {
                              n(c, f, u, h, p, d, i, a, r, o, l, s, 16, e), (g.lineEnd = m), m()
                          }
                          return g
                      }
                  })(t, e)
        ...
        function ml(t, e, n, r, i, a) {
            var o = Ri(a),
                ...
                p = (l * e + o * n) / t
            function d(t, a) {
                return [s * (t *= r) - u * (a *= i) + e, n - u * t - s * a]
            }
            return (
        ...
        function xl(t) {
            return (function (t) {
                var e,
                    ...
                    z = 0.5
                function F(t) {
                    return s(t[0] * Ni, t[1] * Ni)
                }
                function A(t) {
                    return (t = s.invert(t[0], t[1])) && [t[0] * Li, t[1] * Li]
                }
                function M() {
                    var t = ml(f, 0, 0, x, b, m).apply(null, e(d, g)),
                        r = (m ? ml : vl)(f, h - t[0], p - t[1], x, b, m)
                    return (
                        (n = (function (t, e, n) {
                            return (t %= Ei) ? (e || n ? cl(pl(t), dl(e, n)) : pl(t)) : e || n ? dl(e, n) : fl
                        })(_, y, v)),
                        (l = cl(e, r)),
                        (s = cl(n, l)),
                        (o = _l(l, z)),
                ...
                return (
                    ...
                    (F.preclip = function (t) {
                        return arguments.length ? ((w = t), (S = void 0), C()) : w
                    }),
                    (F.postclip = function (t) {
                        return arguments.length ? ((k = t), (T = r = i = a = null), C()) : k
                    }),
                    (F.clipAngle = function (t) {
                        return arguments.length ? ((w = +t ? ul((S = t * Ni)) : ((S = null), ll)), C()) : S * Li
                    }),
                    (F.clipExtent = function (t) {
                        return arguments.length
                            ? ((k =
                                  null == t
                                      ? ((T = r = i = a = null), $i)
                                      : Zi((T = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (a = +t[1][1]))),
                              C())
                            : null == T
                            ? null
                            : [
                    ...
                    (F.translate = function (t) {
                        return arguments.length ? ((h = +t[0]), (p = +t[1]), M()) : [h, p]
                    }),
                    (F.center = function (t) {
                        return arguments.length ? ((d = (t[0] % 360) * Ni), (g = (t[1] % 360) * Ni), M()) : [d * Li, g * Li]
                    }),
                    (F.rotate = function (t) {
                        return arguments.length
                            ? ((_ = (t[0] % 360) * Ni), (y = (t[1] % 360) * Ni), (v = t.length > 2 ? (t[2] % 360) * Ni : 0), M())
                            : [_ * Li, y * Li, v * Li]
                    }),
                    (F.angle = function (t) {
                        return arguments.length ? ((m = (t % 360) * Ni), M()) : m * Li
                    }),
                    (F.reflectX = function (t) {
                        return arguments.length ? ((x = t ? -1 : 1), M()) : x < 0
                    }),
                    (F.reflectY = function (t) {
                        return arguments.length ? ((b = t ? -1 : 1), M()) : b < 0
                    }),
                    (F.precision = function (t) {
                        return arguments.length ? ((o = _l(l, (z = t * t))), C()) : Hi(z)
                    }),
                    ...
                    function () {
                        return (e = t.apply(this, arguments)), (F.invert = e.invert && A), M()
                    }
                )
            })(function () {
                return t
        ...
        var bl = Math.abs,
            Sl = (Math.atan, Math.atan2, Math.ceil, Math.cos, Math.exp, Math.floor),
            wl = (Math.log, Math.max),
            Tl = Math.min,
            kl = (Math.pow, Math.round, Math.sign, Math.sin, Math.tan, Math.PI),
            zl = kl / 2,
            Fl = (Math.SQRT1_2, Ml(2), Ml(kl), 180 / kl),
            Al = kl / 180
        function Ml(t) {
        ...
        function El(t, e) {
            var n,
                ...
                f = n[1]
            return [
                t * (s + (a * (c - o)) / 2 + (a * a * (c - 2 * s + o)) / 2),
                (e > 0 ? zl : -zl) * (u + (a * (f - l)) / 2 + (a * a * (f - 2 * u + l)) / 2),
            ]
        }
        function Ll(t) {
            return t
                    ...
                    var n = (function (t) {
                            ...
                            return function (t, l) {
                                ...
                                var s = 2,
                                    u = t.length,
                                    c = new Array(u)
                                for (c[0] = (e += t[0]) * r + a, c[1] = (n += t[1]) * i + o; s < u; ) (c[s] = t[s]), ++s
                                return c
                            }
                        })(t.transform),
                        r = t.arcs
                ...
                do {
                    ...
                    if (p >= 0 || 1 === a) {
                        ...
                        var d,
                            g = 50
                        do {
                            ;(p = (i = Tl(18, bl(r) / 5)) - (a = Sl(i))),
                                (o = Cl[a][1]),
                                (l = Cl[a + 1][1]),
                                (s = Cl[Tl(19, a + 2)][1]),
                                (r -=
                                    (d = (e >= 0 ? zl : -zl) * (l + (p * (s - o)) / 2 + (p * p * (s - 2 * l + o)) / 2) - e) * Fl)
                        } while (bl(d) > 1e-12 && --g > 0)
                        break
                    }
                } while (--a >= 0)
                var _ = Cl[a][0],
                    y = Cl[a + 1][0],
                    v = Cl[Tl(19, a + 2)][0]
                return [t / (y + (p * (v - _)) / 2 + (p * p * (v - 2 * y + _)) / 2), r * Al]
            })
        var Dl = function (t) {
            ...
            Ol = function (t) {
                var e
                function n() {
                    ;(e = dt('#' + t.div)).empty() && (e = dt('body').append('div').attr('id', t.div)),
                        ...
                        e.style('border-radius', t['border-radius']),
                        e.style('box-shadow', t['box-shadow']),
                        e.style('position', 'absolute'),
                        e.style('font-family', t['font-family']),
                ...
                return (
                    ...
                    (t.padding = t.padding || '5px'),
                    (t.border = t.border || '0px'),
                    (t['border-radius'] = t['border-radius'] || '5px'),
                    (t['box-shadow'] = t['box-shadow'] || '5px 5px 5px grey'),
                    (t['font-family'] = t['font-family'] || 'Helvetica, Arial, sans-serif'),
                    ...
                    (n.ensureTooltipOnScreen = function (n, r) {
                        ...
                        i.offsetTop + i.clientHeight > a.top + l && (i.style.top = i.offsetTop - i.clientHeight + 'px')
                    }),
                    n(),
                    n
                )
            ...
            Rl = {
                EUR_3035: {
                    ...
                    en: [
                        ...
                        { text: 'SLOVENIA', cc: 'SI', x: 4735e3, y: 2522e3, class: 'countries', size: 7, rotate: -30 },
                        ...
                        { text: 'TURKEY', cc: 'TR', x: 651e4, y: 21e5, class: 'countries', size: 12 },
        ...
        un({ decimal: '.', thousands: ' ', grouping: [3], currency: ['', '€'] })
        var jl = function t(e, n) {
                ...
                ;(i.width_ = Math.min(800, window.innerWidth)),
                    ...
                    (i.nutsrgFillStyle_ = 'white'),
                    (i.nutsrgSelFillSty_ = '#e0bcdf'),
                    (i.nutsbnStroke_ = { 0: 'black', 1: 'grey', 2: 'grey', 3: 'grey', oth: 'grey', co: 'black' }),
                    (i.nutsbnStrokeWidth_ = { 0: 1, 1: 0.4, 2: 0.4, 3: 0.4, oth: 0, co: 0 }),
                    (i.cntrgFillStyle_ = '#f4f4f4'),
                    (i.cntbnStroke_ = { eu: 'black', efta: 'black', cc: 'black', oth: 'black', co: '#7f7f7f' }),
                    (i.cntbnStrokeWidth_ = { eu: 0.8, efta: 0.8, cc: 0.8, oth: 0.8, co: 0.5 }),
                    (i.worldFillStyle_ = '#E6E6E6'),
                    (i.worldStroke_ = 'black'),
                    (i.worldStrokeWidth_ = 1),
                    (i.worldCoastStroke_ = 'none'),
                    (i.worldCoastStrokeWidth_ = 0.3),
                    (i.seaFillStyle_ = 'white'),
                    (i.drawCoastalMargin_ = !0),
                    ...
                    (i.labelStroke_ = { seas: '#003399', countries: 'black', cc: 'black', values: 'black' }),
                    (i.labelStrokeWidth_ = { seas: 0.5, countries: 0.5, cc: 0.5, values: 0.5 }),
                    (i.labelOpacity_ = { seas: 1, countries: 0.8, cc: 0.8, values: 0.9 }),
                    (i.labelValuesFontSize_ = 10),
                    (i.labelShadow_ = !1),
                    (i.labelShadowWidth_ = { seas: 3, countries: 3, cc: 3, values: 1 }),
                    (i.labelShadowColor_ = { seas: 'white', countries: 'white', cc: 'white', values: 'white' }),
                    (i.showSourceLink_ = !0),
                    (i.bottomText_ = 'Administrative boundaries: ©EuroGeographics ©UN-FAO ©INSTAT ©Turkstat'),
                    ...
                    (i.nuts2jsonBaseURL_ = 'https://raw.githubusercontent.com/eurostat/Nuts2json/master/pub/v2/'),
                    (i.insets_ = []),
                    (i.insetTemplates_ = {}),
                ...
                ;['tooltip_', 'nuts2jsonBaseURL_'].forEach(function (t) {
                    i[t.substring(0, t.length - 1)] = function (e) {
                        ...
                        if ('object' === Nn(e) && null !== e) for (var n in e) i[t][n] = e[n]
                        else i[t] = e
                        return l(t, e), i
                    }
                })
                            ...
                            if (Array.isArray(i.insetTemplates_[n]))
                                for (var r = 0; r < i.insetTemplates_[n].length; r++)
                                    if (Array.isArray(i.insetTemplates_[n][r]))
                                        for (var a = 0; a < i.insetTemplates_[n][r].length; a++) i.insetTemplates_[n][r][a][t](e)
                                    else i.insetTemplates_[n][r][t](e)
                            else i.insetTemplates_[n][t](e)
                }
                                ...
                                for (var a = 0; a < i.insetTemplates_[r].length; a++)
                                    if (Array.isArray(i.insetTemplates_[r][a]))
                                        for (var o = 0; o < i.insetTemplates_[r][a].length; o++) {
                                            var l = i.insetTemplates_[r][a][o]
                                            l.seaFillStyle_ = i.seaFillStyle_
                                        }
                                    else {
                                        var s = i.insetTemplates_[r][a]
                                        s.seaFillStyle_ = i.seaFillStyle_
                                    }
                            else {
                                var u = i.insetTemplates_[r]
                                u.seaFillStyle_ = i.seaFillStyle_
                            }
                        return i
                    }),
                    (i.cntrgFillStyle = function (t) {
                        if (!arguments.length) return i.cntrgFillStyle_
                        if (((i.cntrgFillStyle_ = t), 'WORLD' == i.geo_)) {
                            var e = zi('.worldrg')
                            e && e.style('fill', i.cntrgFillStyle_)
                        } else {
                            var n = zi('.cntrg')
                            n && n.style('fill', i.cntrgFillStyle_)
                        }
                        for (var r in i.insetTemplates_)
                            if (Array.isArray(i.insetTemplates_[r]))
                                for (var a = 0; a < i.insetTemplates_[r].length; a++)
                                    if (Array.isArray(i.insetTemplates_[r][a]))
                                        for (var o = 0; o < i.insetTemplates_[r][a].length; o++) {
                                            var l = i.insetTemplates_[r][a][o]
                                            l.cntrgFillStyle_ = i.cntrgFillStyle_
                                        }
                                    else {
                                        var s = i.insetTemplates_[r][a]
                                        s.cntrgFillStyle_ = i.cntrgFillStyle_
                                    }
                            else {
                                var u = i.insetTemplates_[r]
                                u.cntrgFillStyle_ = i.cntrgFillStyle_
                            }
                        return i
                    }),
                                ...
                                for (var n = 0; n < i.insetTemplates_[e].length; n++)
                                    if (Array.isArray(i.insetTemplates_[e][n]))
                                        for (var r = 0; r < i.insetTemplates_[e][n].length; r++) {
                                            ...
                                            a.nutsrgFillStyle_ = i.nutsrgFillStyle_
                                        }
                                    else {
                                        var o = i.insetTemplates_[e][n]
                                        o.nutsrgFillStyle_ = i.nutsrgFillStyle_
                                    }
                            else {
                                var l = i.insetTemplates_[e]
                                l.nutsrgFillStyle_ = i.nutsrgFillStyle_
                            }
                        return i
                    }),
                    (i.drawCoastalMargin = function (t) {
                        if (!arguments.length) return i.drawCoastalMargin_
                        i.drawCoastalMargin_ = t
                        var e = zi('#g_coast_margin'),
                            n = dt('#coastal_blur'),
                            r = i.svg_ ? i.svg_.select('#zoomgroup' + i.svgId_) : null
                        if (e._groups[0][0] && 0 == t) e.remove()
                            ...
                            for (var o in i.insetTemplates_)
                                if (Array.isArray(i.insetTemplates_[o]))
                                    for (var l = 0; l < i.insetTemplates_[o].length; l++)
                                        if (Array.isArray(i.insetTemplates_[o][l]))
                                            for (var s = 0; s < i.insetTemplates_[o][l].length; s++) {
                                                var u = i.insetTemplates_[o][l][s]
                                                ;(u.drawCoastalMargin_ = i.drawCoastalMargin_),
                                                    i.svg().select('#zoomgroup' + u.svgId_),
                                                    i.drawCoastalMargin_ && a(u)
                                            }
                                        else {
                                            var c = i.insetTemplates_[o][l]
                                            ;(c.drawCoastalMargin_ = i.drawCoastalMargin_),
                                                i.svg().select('#zoomgroup' + c.svgId_),
                                                i.drawCoastalMargin_ && a(c)
                                        }
                                else {
                                    var f = i.insetTemplates_[o]
                                    ;(f.drawCoastalMargin_ = i.drawCoastalMargin_),
                                        i.svg().select('#zoomgroup' + f.svgId_),
                                        i.drawCoastalMargin_ && a(f)
                                }
                            i.drawCoastalMargin_ && a(i),
                                zi('#g_coast_margin').each(function () {
                                    'WORLD' == i.geo_
                                        ? this.parentNode.insertBefore(this, this.parentNode.childNodes[3])
                                        : this.parentNode.insertBefore(this, this.parentNode.childNodes[1])
                                })
                    ...
                    (i.coastalMarginWidth = function (t) {
                        ...
                        for (var e in ((i.coastalMarginWidth_ = t), i.insetTemplates_))
                            if (Array.isArray(i.insetTemplates_[e]))
                                ...
                                var l = i.insetTemplates_[e]
                                ;(l.coastalMarginWidth_ = i.coastalMarginWidth_), l.drawCoastalMargin(!0)
                            }
                    ...
                    (i.coastalMarginColor = function (t) {
                        ...
                        for (var e in ((i.coastalMarginColor_ = t), i.insetTemplates_))
                            if (Array.isArray(i.insetTemplates_[e]))
                                ...
                                var l = i.insetTemplates_[e]
                                ;(l.coastalMarginColor_ = i.coastalMarginColor_), l.drawCoastalMargin(!0)
                            }
                        return i.drawCoastalMargin(!0), i
                    })
                var s = void 0,
                    ...
                    c = void 0
                function f(t, e) {
                    var n = t.labelsConfig_,
                        r = t.lg_,
                        i = [],
                        a = e.append('g').attr('class', 'labels-container')
                    if (
                        ((t.labelsToShow_.includes('countries') || t.labelsToShow_.includes('seas')) &&
                            (i = n[t.geo_ + '_' + t.proj_][r] ? n[t.geo_ + '_' + t.proj_][r] : n[t.geo_ + '_' + t.proj_].en),
                        t.labelsToShow_.includes('cc') && (i = i.concat(n[t.geo_ + '_' + t.proj_].cc)),
                        ...
                        'mixed' == t.nutsLvl_
                            ? ((t._geom.mixed.rg0 = t._geom.nutsrg),
                              (t._geom.mixed.rg1 = Nl(u[1], u[1].objects.nutsrg).features),
                              (t._geom.mixed.rg2 = Nl(u[2], u[2].objects.nutsrg).features),
                              (t._geom.mixed.rg3 = Nl(u[3], u[3].objects.nutsrg).features),
                              (o = t._geom.mixed.rg0.concat(t._geom.mixed.rg1, t._geom.mixed.rg2, t._geom.mixed.rg3)))
                            : (o = t._geom.nutsrg),
                            s
                                .selectAll('g')
                                .data(o)
                ...
                ;(i.isGeoReady = function () {
                    ...
                    (i.getGeoDataPromise = function () {
                        var t = this
                        if ('mixed' == i.nutsLvl_ && 'WORLD' !== i.geo_) {
                            var e = []
                            return (
                    ...
                    (i.updateGeoMT = function (t) {
                        if (((s = null), (u = null), (c = null), 'mixed' == i.nutsLvl_ && 'WORLD' !== i.geo_)) {
                            var e = i.getGeoDataPromise()
                            Promise.all(e).then(
                                function (e) {
                                    ;(u = e), (s = e[0]), n && (c = [e[4], e[5], e[6], e[7]]), i.buildMapTemplate(), t && t()
                                },
                                function (t) {
                                    console.error(t)
                                }
                            ...
                            Promise.all(r).then(
                                function (e) {
                                    ;(s = e[0]), n && (c = e[1]), i.buildMapTemplate(), t && t()
                                },
                                function (t) {
                                    console.error(t)
                                }
                            ...
                            if (Array.isArray(i.insetTemplates_[a]))
                                for (var o = 0; o < i.insetTemplates_[a].length; o++)
                                    if (Array.isArray(i.insetTemplates_[a][o]))
                                        for (var l = 0; l < i.insetTemplates_[a][o].length; l++)
                                            i.insetTemplates_[a][o][l].updateGeoMT(t)
                                    else i.insetTemplates_[a][o].updateGeoMT(t)
                            else i.insetTemplates_[a].updateGeoMT(t)
                        return i
                    }),
                    (i.buildMapTemplateBase = function () {
                        i.insetTemplates_ = {}
                        var t = dt('#' + i.svgId())
                        0 == t.size() && (t = dt('body').append('svg').attr('id', i.svgId())),
                            i.svg(t),
                            ...
                            'WORLD' == i.geo_.toUpperCase() &&
                                ...
                                t.attr('width', i.width()).attr('height', i.height()),
                                (i.proj_ = 54030)),
                        ...
                        var e = t
                            ...
                            n = e.append('g').attr('id', 'zoomgroup' + i.svgId_)
                        i.insetBoxPosition_ ||
                            (i.insetBoxPosition_ = [
                                i.width() - i.insetBoxWidth() - 2 * i.insetBoxPadding(),
                                2 * i.insetBoxPadding(),
                            ])
                        var r = e
                            .append('g')
                            .attr('id', 'insetsgroup')
                            .attr('transform', 'translate(' + i.insetBoxPosition()[0] + ',' + i.insetBoxPosition()[1] + ')')
                        'default' === i.insets_ && (i.insets_ = Ul(i.insetBoxWidth(), i.insetBoxPadding()))
                        for (var a = 0; a < i.insets_.length; a++) {
                            var o = i.insets_[a]
                            if (
                                ((o.svgId = o.svgId || 'inset' + o.geo + Math.random().toString(36).substring(7)),
                                0 == dt('#' + o.svgId).size())
                            ) {
                                var l = null == o.x ? i.insetBoxPadding_ : o.x,
                                    s = null == o.y ? i.insetBoxPadding_ + a * (i.insetBoxPadding_ + i.insetBoxWidth_) : o.y
                                r.append('g')
                                    .attr('id', 'insetzg' + o.svgId)
                                    .attr('transform', 'translate(' + l + ',' + s + ')')
                                    .append('svg')
                                    .attr('id', o.svgId)
                            }
                            if (i.insetTemplates_[o.geo]) {
                                var u = p(o, i)
                                u.buildMapTemplateBase(), (i.insetTemplates_[o.geo] = [i.insetTemplates_[o.geo], u])
                            } else i.insetTemplates_[o.geo] = p(o, i).buildMapTemplateBase()
                        }
                        if (
                            (e
                                .append('rect')
                            ...
                            var c = (function () {
                                ...
                                function g(t, e) {
                                    return (e = Math.max(l[0], Math.min(l[1], e))) === t.k ? t : new gi(e, t.x, t.y)
                                }
                                function _(t, e, n) {
                                    var r = e[0] - n[0] * t.k,
                                        i = e[1] - n[1] * t.k
                                    ...
                                    t.on('start.zoom', function () {
                                        ...
                                        .tween('zoom', function () {
                                            var t = this,
                                                ...
                                                a = m(t, i),
                                                o = r.apply(t, i),
                                                l = null == n ? y(o) : 'function' == typeof n ? n.apply(t, i) : n,
                                            ...
                                            return function (t) {
                                                if (1 === t) t = f
                                                    ...
                                                    var e = h(t),
                                                        n = s / e[2]
                                                    t = new gi(n, l[0] - e[0] * n, l[1] - e[1] * n)
                                                }
                                                a.zoom(null, t)
                                            }
                                        })
                                ...
                                function b() {
                                    if (n.apply(this, arguments)) {
                                        var t = m(this, arguments),
                                            e = this.__zoom,
                                            r = Math.max(l[0], Math.min(l[1], e.k * Math.pow(2, a.apply(this, arguments)))),
                                            o = $n(this)
                                        if (t.wheel)
                                            ...
                                            if (e.k === r) return
                                            ;(t.mouse = [o, e.invert(o)]), Tr(this), t.start()
                                        }
                                        mi(),
                                            (t.wheel = setTimeout(u, 150)),
                                            t.zoom('mouse', i(_(g(e, r), t.mouse[0], t.mouse[1]), t.extent, s))
                                    }
                                    function u() {
                                        ;(t.wheel = null), t.end()
                                    }
                                ...
                                function S() {
                                    if (!e && n.apply(this, arguments)) {
                                        var t = m(this, arguments, !0),
                                            r = dt(et.view).on('mousemove.zoom', u, !0).on('mouseup.zoom', c, !0),
                                            a = $n(this),
                                            o = et.clientX,
                                            l = et.clientY
                                        qn(et.view), vi(), (t.mouse = [a, this.__zoom.invert(a)]), Tr(this), t.start()
                                    }
                                    function u() {
                                        if ((mi(), !t.moved)) {
                                            var e = et.clientX - o,
                                        ...
                                        t.zoom('mouse', i(_(t.that.__zoom, (t.mouse[0] = $n(t.that)), t.mouse[1]), t.extent, s))
                                    }
                                    function c() {
                                        r.on('mousemove.zoom mouseup.zoom', null), Vn(et.view, t.moved), mi(), t.end()
                                    }
                                }
                                function w() {
                                    if (n.apply(this, arguments)) {
                                        var t = this.__zoom,
                                            e = $n(this),
                                            a = t.invert(e),
                                            o = t.k * (et.shiftKey ? 0.5 : 2),
                                            l = i(_(g(t, o), e, a), r.apply(this, arguments), s)
                                        mi(),
                                            u > 0
                                                ? dt(this).transition().duration(u).call(v, l, e)
                                                : dt(this).call(d.transform, l)
                                    }
                                }
                                function T() {
                                    if (n.apply(this, arguments)) {
                                        var e,
                                            ...
                                            o = et.touches,
                                            l = o.length,
                                            s = m(this, arguments, et.changedTouches.length === l)
                                        for (vi(), r = 0; r < l; ++r)
                                            (a = [(a = Qn(this, o, (i = o[r]).identifier)), this.__zoom.invert(a), i.identifier]),
                                                s.touch0
                                                    ? s.touch1 || s.touch0[2] === a[2] || ((s.touch1 = a), (s.taps = 0))
                                                    : ((s.touch0 = a), (e = !0), (s.taps = 1 + !!t))
                                        t && (t = clearTimeout(t)),
                                            e &&
                                                (s.taps < 2 &&
                                ...
                                function k() {
                                    if (this.__zooming) {
                                        var e,
                                            ...
                                            l = et.changedTouches,
                                            u = l.length
                                        for (mi(), t && (t = clearTimeout(t)), o.taps = 0, e = 0; e < u; ++e)
                                            (r = Qn(this, l, (n = l[e]).identifier)),
                                                o.touch0 && o.touch0[2] === n.identifier
                                                    ? (o.touch0[0] = r)
                                                    : o.touch1 && o.touch1[2] === n.identifier && (o.touch1[0] = r)
                                        if (((n = o.that.__zoom), o.touch1)) {
                                            var c = o.touch0[0],
                                                f = o.touch0[1],
                                                h = o.touch1[0],
                                                p = o.touch1[1],
                                                d = (d = h[0] - c[0]) * d + (d = h[1] - c[1]) * d,
                                        ...
                                        o.zoom('touch', i(_(n, r, a), o.extent, s))
                                    }
                                }
                                function z() {
                                    if (this.__zooming) {
                                        ...
                                        if ((r.touch1 && !r.touch0 && ((r.touch0 = r.touch1), delete r.touch1), r.touch0))
                                            ...
                                            var o = dt(this).on('dblclick.zoom')
                                            o && o.apply(this, arguments)
                                        }
                                    }
                                }
                                return (
                                    (d.transform = function (t, e, n) {
                                        var r = t.selection ? t.selection() : t
                                        r.property('__zoom', Si),
                                            t !== r
                                                ? v(t, e, n)
                                    ...
                                    (d.translateTo = function (t, e, n, a) {
                                        d.transform(
                                            t,
                                            function () {
                                                var t = r.apply(this, arguments),
                                                    o = this.__zoom,
                                                    l = null == a ? y(t) : 'function' == typeof a ? a.apply(this, arguments) : a
                                                return i(
                                                    _i
                                                        .translate(l[0], l[1])
                                                        .scale(o.k)
                                    ...
                                    (x.prototype = {
                                        ...
                                        emit: function (t) {
                                            ...
                                            })(new di(d, t, this.that.__zoom), f.apply, f, [t, this.that, this.args])
                                        },
                                    }),
                                    (d.wheelDelta = function (t) {
                                        return arguments.length ? ((a = 'function' == typeof t ? t : pi(+t)), d) : a
                                    }),
                                    (d.filter = function (t) {
                                        return arguments.length ? ((n = 'function' == typeof t ? t : pi(!!t)), d) : n
                                    }),
                                    (d.touchable = function (t) {
                                        return arguments.length ? ((o = 'function' == typeof t ? t : pi(!!t)), d) : o
                                    }),
                                    (d.extent = function (t) {
                                        return arguments.length
                                            ? ((r =
                                    ...
                                    (d.scaleExtent = function (t) {
                                        return arguments.length ? ((l[0] = +t[0]), (l[1] = +t[1]), d) : [l[0], l[1]]
                                    }),
                                ...
                                .on('zoom', function () {
                                    for (
                                        var t = et.transform.k, e = ['gra', 'bn_0', 'bn_co', 'cntbn', 'symbol'], r = 0;
                                        r < e.length;
                                        r++
                                    )
                                        i.svg()
                                    ...
                                    n.attr('transform', et.transform)
                                })
                                .on('end', function () {
                                    var e = yi(t.node()),
                                        n = ($n(this), e.invert([i.width_ / 2, i.height_ / 2]))
                                    i._projection.invert(n)
                                })
                            t.call(c)
                        }
                        return i
                    ...
                    (i.buildMapTemplate = function () {
                        i.tooltip_ ? (i._tooltip = Ol(i.tooltip_)) : (i._tooltip = Ol())
                        var t = Hl[i.geo() + '_' + i.proj()]
                        i.geoCenter() ||
                            (t
                                ? i.geoCenter(t.geoCenter)
                                : i.geoCenter([0.5 * (s.bbox[0] + s.bbox[2]), 0.5 * (s.bbox[1] + s.bbox[3])])),
                            i.pixSize() ||
                                (t
                                    ? i.pixSize((800 * t.pixSize) / i.width())
                                    : i.pixSize(
                                          Math.min((s.bbox[2] - s.bbox[0]) / i.width_, (s.bbox[3] - s.bbox[1]) / i.height_)
                                      ))
                        var e,
                            a = [
                        ...
                        'WORLD' == i.geo_
                            ...
                            : (i._projection = (function () {
                                  ...
                                  return (
                                      ...
                                      (m.postclip = function (t) {
                                          return arguments.length ? ((y = t), (p = n = r = i = null), v()) : y
                                      }),
                                      (m.clipExtent = function (t) {
                                          return arguments.length
                                              ? ((y =
                                                    null == t
                                                        ? ((p = n = r = i = null), $i)
                                                        : Zi((p = +t[0][0]), (n = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))),
                                                v())
                                              : null == p
                                              ? null
                                              : [
                                      ...
                                      (m.angle = function (n) {
                                          return arguments.length ? ((e = Wi((h = (n % 360) * Ni))), (t = Ri(h)), v()) : h * Li
                                      }),
                            ...
                            (i._geom.path = (function (t, e) {
                                ...
                                function a(t) {
                                    return (
                                        t && ('function' == typeof i && r.pointRadius(+i.apply(this, arguments)), oa(t, n(r))),
                                        r.result()
                                    )
                                }
                                return (
                                    (a.area = function (t) {
                                        return oa(t, n(Ra)), Ra.result()
                                    }),
                                    (a.measure = function (t) {
                                        return oa(t, n(Eo)), Eo.result()
                                    }),
                                    (a.bounds = function (t) {
                                        return oa(t, n(ha)), ha.result()
                                    }),
                                    (a.centroid = function (t) {
                                        return oa(t, n(ro)), ro.result()
                                    }),
                                    (a.projection = function (e) {
                                        return arguments.length ? ((n = null == e ? ((t = null), $i) : (t = e).stream), a) : t
                                    }),
                                    (a.context = function (t) {
                                        return arguments.length
                                            ? ((r = null == t ? ((e = null), new Lo()) : new io((e = t))),
                                    ...
                                    (a.pointRadius = function (t) {
                                        return arguments.length
                                            ? ((i = 'function' == typeof t ? t : (r.pointRadius(+t), +t)), a)
                                            : i
                                    }),
                            ...
                            'WORLD' == i.geo_
                                ? ((i._geom.worldrg = Nl(s, s.objects.CNTR_RG_20M_2020_4326).features),
                                  (i._geom.worldbn = Nl(s, s.objects.CNTR_BN_20M_2020_4326).features),
                                  (i._geom.kosovo = Nl(s, s.objects.NUTS_BN_20M_2021_RS_XK_border).features),
                                  (i._geom.gra = [Oo().step([30, 30])()]))
                                : ((i._geom.gra = Nl(s, s.objects.gra).features),
                                  (i._geom.nutsrg = Nl(s, s.objects.nutsrg).features),
                                  (i._geom.nutsbn = Nl(s, s.objects.nutsbn).features),
                                  (i._geom.cntrg = Nl(s, s.objects.cntrg).features),
                                  (i._geom.cntbn = Nl(s, s.objects.cntbn).features))
                        var o,
                            l = i.svg().select('#zoomgroup' + i.svgId_)
                        if (
                            (l.selectAll('*').remove(),
                            l
                                .append('rect')
                        ...
                        if (
                            ...
                            if ('mixed' == i.nutsLvl_) {
                                if (
                                    ...
                                    (i._geom.mixed.rg1 = Nl(u[1], u[1].objects.nutsrg).features),
                                    (i._geom.mixed.rg2 = Nl(u[2], u[2].objects.nutsrg).features),
                                    (i._geom.mixed.rg3 = Nl(u[3], u[3].objects.nutsrg).features),
                                    [i._geom.mixed.rg0, i._geom.mixed.rg1, i._geom.mixed.rg2, i._geom.mixed.rg3].forEach(
                                        function (t, e) {
                                            l.append('g')
                                                .attr('id', 'g_nutsrg')
                                                .selectAll('path')
                                    ...
                                    var d = Nl(Il[i.scale_], 'nutsbn_1').features
                                ...
                                l
                                    ...
                                    .style('stroke-width', function (t) {
                                        return 'T' === (t = t.properties).co
                                            ...
                                            : t.lvl > 0
                                            ? i.nutsbnStrokeWidth_[t.lvl]
                                            : i.nutsbnStrokeWidth_[t.lvl] || 0.2
                                    }),
                                'EUR' == i.geo_))
                        ) {
                            var g = Nl(Il[i.scale_], 'nutsbn_1').features
                            i.bordersToShow_.includes('cc') &&
                                l
                                    .append('g')
                                    .attr('id', 'g_kosovo')
                        ...
                        if (
                                      ...
                                      i._geom.worldrg.forEach(function (t) {
                                          var e = (function (t) {
                                              for (var e = 1; e < arguments.length; e++) {
                                                  ...
                                                  e % 2
                                                      ? Wl(Object(n), !0).forEach(function (e) {
                                                            Pn(t, e, n[e])
                                                        })
                                                      : Object.getOwnPropertyDescriptors
                                                      ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n))
                                                      : Wl(Object(n)).forEach(function (e) {
                                                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(n, e))
                                                        })
                                              }
                                              return t
                                          })({}, t)
                                          ;(e.geometry = { coordinates: Xo(t), type: 'Point' }), o.push(e)
                                      })),
                                l
                                    .append('g')
                                    .attr('id', 'g_ps')
                                    ...
                                    .attr('transform', function (t) {
                                        return 'translate(' + i._projection(t.geometry.coordinates) + ')'
                                    })
                                    .attr('class', 'symbol')
                                    .style('fill', 'gray')
                                    .attr('id', function (t) {
                                    ...
                                    .on('mouseover', function (t) {
                                        var e = dt(this.childNodes[0])
                                        e.attr('fill___', e.style('fill')),
                                            e.style('fill', i.nutsrgSelFillSty_),
                                            i._tooltip && i._tooltip.mouseover(i.tooltip_.textFunction(t, i))
                                    })
                                    .on('mousemove', function () {
                                        i._tooltip && i._tooltip.mousemove()
                                    })
                                    .on('mouseout', function () {
                                        var t = dt(this.childNodes[0])
                                        t.style('fill', t.attr('fill___')), i._tooltip && i._tooltip.mouseout()
                                    })),
                            i.labelling_ && f(i, l),
                            i.title() &&
                            ...
                            i.subtitle() &&
                                (i.subtitlePosition() ||
                                    i.subtitlePosition([10, 8 + i.titleFontSize() + 5 + i.subtitleFontSize()]),
                                i
                                    .svg()
                                    .append('text')
                            ...
                            i.bottomText() &&
                                i
                                    ...
                                    .on('mousemove', function () {
                                        i.botTxtTooltipTxt_ && i._tooltip.mousemove()
                                    })
                                    .on('mouseout', function () {
                                        i.botTxtTooltipTxt_ && i._tooltip.mouseout(),
                                            i._tooltip.style('max-width', i._tooltip.mw___)
                                    }),
                            ...
                            i.showScalebar_ &&
                                ...
                                (function () {
                                    var t = i
                                        ...
                                        e = (i.scalebarSegmentHeight_, 5),
                                        n = i.scalebarMaxWidth_,
                                        r = i.scalebarTextOffset_[0],
                                        a = i.scalebarTextOffset_[1],
                                        o = i.pixSize_,
                                        l = (function (t) {
                                    ...
                                    c
                                        ...
                                        c
                                            .append('text')
                                            .attr('x', e + r)
                                            .attr('y', i.scalebarTickHeight_ + a)
                                            .text('0')
                                    ...
                                    if (p >= 15) {
                                        for (var d = 1; d < f; d++)
                                            c
                                                .append('line')
                                                .attr('x1', e + i.scalebarStrokeWidth_ / 2 + d * p)
                                                .attr('y1', 1)
                                                .attr('x2', e + i.scalebarStrokeWidth_ / 2 + d * p)
                                                .attr('y2', i.scalebarTickHeight_)
                                                .style('stroke', '#000')
                                                .style('stroke-width', '0.8px')
                                                .style('stroke', 'black')
                                        ...
                                        for (var g = -1; g < f; g += 2)
                                            if (1 == g)
                                                t.append('line')
                                                    .attr('x1', e + i.scalebarStrokeWidth_ - 1)
                                                    .attr('y1', i.scalebarSegmentHeight_ / 2)
                                                    .attr('x2', e + i.scalebarStrokeWidth_ / 2 + g * p)
                                                    .attr('y2', i.scalebarSegmentHeight_ / 2)
                                                    .style('stroke', '#000')
                                                    .style('stroke-width', i.scalebarStrokeWidth_ + 'px')
                                            else {
                                                var _ = e + i.scalebarStrokeWidth_ / 2 + (g - 1) * p
                                                _ > 0 &&
                                                    t
                                                        .append('line')
                                                        .attr('x1', _)
                                        ...
                                        t.append('line')
                                            .attr('x1', e + i.scalebarStrokeWidth_ - 1)
                                            .attr('y1', i.scalebarSegmentHeight_ / 2)
                                            .attr('x2', e + i.scalebarStrokeWidth_ / 2 + p * f)
                                            .attr('y2', i.scalebarSegmentHeight_ / 2)
                                            .style('stroke', '#000')
                                            .style('stroke-width', i.scalebarStrokeWidth_ + 'px')
                                    c
                    ...
                    (i.updateLabels = function () {
                        ...
                        if ((t && t.remove(), i.labelling_)) {
                            ...
                            f(i, e), i.labelsToShow_.includes('values') && i.updateValuesLabels()
                        }
                    })
                var p = function (e, r) {
                    var a = t(0, n)
                    for (var o in (((e = e || {}).proj = e.proj || Bl[e.geo]),
            ...
            Ul = function (t, e) {
                for (
                    var n = [
                            { geo: 'IC', x: 0, y: 0, width: t, height: 0.3 * t },
                            { geo: 'CARIB', x: 0, y: 0.3 * t + e, width: 0.5 * t, height: t },
                            { geo: 'GF', x: 0.5 * t, y: 0.3 * t + e, width: 0.5 * t, height: 0.75 * t },
                            { geo: 'YT', x: 0.5 * t, y: 1.05 * t + e, width: 0.25 * t, height: 0.25 * t },
                            { geo: 'RE', x: 0.75 * t, y: 1.05 * t + e, width: 0.25 * t, height: 0.25 * t },
                            { geo: 'PT20', x: 0, y: 1.3 * t + 2 * e, width: 0.75 * t, height: 0.25 * t },
                            { geo: 'PT30', x: 0.75 * t, y: 1.3 * t + 2 * e, width: 0.25 * t, height: 0.25 * t },
                            { geo: 'MT', x: 0, y: 1.55 * t + 3 * e, width: 0.25 * t, height: 0.25 * t },
                            { geo: 'LI', x: 0.25 * t, y: 1.55 * t + 3 * e, width: 0.25 * t, height: 0.25 * t },
                            { geo: 'SJ_SV', x: 0.5 * t, y: 1.55 * t + 3 * e, width: 0.25 * t, height: 0.25 * t },
                            { geo: 'SJ_JM', x: 0.75 * t, y: 1.55 * t + 3 * e, width: 0.25 * t, height: 0.25 * t },
                        ],
                        r = 0;
                    r < n.length;
                    r++
        ...
        function Kl(t) {
            ...
            function r(t, e) {
                ...
                for (10 === t.charCodeAt(a - 1) && --a, 13 === t.charCodeAt(a - 1) && --a; (r = c()) !== ql; ) {
                    for (var f = []; r !== Gl && r !== ql; ) f.push(r), (r = c())
            ...
            function o(t) {
                return null == t
                    ...
                    ? (function (t) {
                          ...
                          return isNaN(t)
                              ? 'Invalid Date'
                              : ((e = t.getUTCFullYear()) < 0 ? '-' + Xl(-e, 6) : e > 9999 ? '+' + Xl(e, 6) : Xl(e, 4)) +
                                    '-' +
                                    Xl(t.getUTCMonth() + 1, 2) +
                                    '-' +
                                    Xl(t.getUTCDate(), 2) +
                                    (a
                                        ? 'T' + Xl(n, 2) + ':' + Xl(r, 2) + ':' + Xl(i, 2) + '.' + Xl(a, 3) + 'Z'
                                        : i
                                        ? 'T' + Xl(n, 2) + ':' + Xl(r, 2) + ':' + Xl(i, 2) + 'Z'
                                        : r || n
                                        ? 'T' + Xl(n, 2) + ':' + Xl(r, 2) + 'Z'
                                        : '')
                      })(t)
            ...
            return {
                ...
                parseRows: r,
                format: function (e, n) {
                    return null == n && (n = Yl(e)), [n.map(o).join(t)].concat(i(e, n)).join('\n')
                },
                formatBody: function (t, e) {
                    return null == e && (e = Yl(t)), i(t, e).join('\n')
                },
        ...
        var Jl = Kl(','),
            Zl = Jl.parse,
            $l = (Jl.parseRows, Jl.format, Jl.formatBody, Jl.formatRows, Jl.formatRow, Jl.formatValue, Kl('\t')),
            Ql = $l.parse
        function ts(t) {
            if (!t.ok) throw new Error(t.status + ' ' + t.statusText)
            return t.text()
        ...
        function es(t, e) {
            return fetch(t, e).then(ts)
        }
        function ns(t) {
            return function (e, n, r) {
                return (
                    2 === arguments.length && 'function' == typeof n && ((r = n), (n = void 0)),
                    es(e, n).then(function (e) {
                        return t(e, r)
                    })
                )
            }
        }
        $l.parseRows, $l.format, $l.formatBody, $l.formatRows, $l.formatRow, $l.formatValue
        var rs = ns(Zl)
        function is(t, e) {
            var n,
                r,
                ...
                o = function (t, e, n) {
                    var r,
                        i = []
                    if ((n && !os(n.name) && (n = null), 'string' == typeof t && (t = [t]), Array.isArray(t) || as(t))) {
                        if (t.length === e)
                            return n &&
                                -1 ===
            ...
            if (((this.length = 0), (this.id = []), null != t))
                switch (((this.class = t.class || 'bundle'), this.class)) {
                    case 'bundle':
                        var l = [],
                            s = 0
                        if (((this.error = null), (this.length = 0), null === t || 'object' != typeof t))
                            return void (this.class = null)
                        if (t.hasOwnProperty('error')) return void (this.error = t.error)
                        if ('dataset' === t.class || 'collection' === t.class || 'dimension' === t.class) return new is(t)
                        for (r in t) s++, l.push(r)
                        ;(this.__tree__ = t), (this.length = s), (this.id = l)
                        break
                    case 'dataset':
                        ...
                        if (
                            ...
                            Array.isArray(this.value) || as(this.value))
                        )
                            c = this.value.length
                        else {
                            var h = 1
                            for (u = f.length; u--; ) h *= f[u]
                            c = h
                        }
                        if (
                            ...
                            var p = n.dimension,
                                d = n.role || (!n.version && p.role) || null,
                                g = n.id || p.id,
                                _ = f.length,
                                y = function (t) {
                            ...
                            for (var S = 0, w = this.length; S < w; S++)
                                if (p[g[S]].category.hasOwnProperty('index')) {
                                    if (Array.isArray(p[g[S]].category.index)) {
                                        var T = {},
                                            k = p[g[S]].category.index
                                        for (i = k.length, a = 0; a < i; a++) T[k[a]] = a
                                        p[g[S]].category.index = T
                                    }
                                } else {
                                    var z = 0
                                    for (r in ((p[g[S]].category.index = {}), p[g[S]].category.label))
                                        p[g[S]].category.index[r] = z++
                                }
                        } else this.length = 0
                        break
                    case 'dimension':
                    ...
                    case 'collection':
                        if (
                            ...
                            var C = t.link.item
                            if (((this.length = Array.isArray(C) ? C.length : 0), this.length))
                                for (a = 0; a < this.length; a++) this.id[a] = C[a].href
                        }
                }
        }
        function as(t) {
        ...
        ns(Ql),
            ...
            (is.prototype.Dataset = function (t) {
                ...
                if ('collection' === this.class) {
                    ...
                    if (void 0 === t) {
                        for (e = i.length; r < e; r++) n.push(new is(i[r]))
                        return n
                    }
                    if ('number' == typeof t && t >= 0 && t < i.length) return new is(i[t])
                    if ('string' == typeof t) for (e = i.length; r < e; r++) if (i[r].href === t) return new is(i[r])
                    return null
                }
                ...
                return void 0 === o ? null : new is({ class: 'dataset', __tree__: o })
            }),
            (is.prototype.Dimension = function (t, e) {
                ...
                var n,
                    ...
                    a = function (t, e) {
                        if (null !== t)
                            for (var n in t) for (var r = null !== t[n] ? t[n].length : 0; r--; ) if (t[n][r] === e) return n
                        return null
                    }
                ...
                if ('object' == typeof t) {
                    if (t.hasOwnProperty('role')) {
                        for (n = 0; n < i; n++) {
                            var s = this.id[n]
                            a(l, s) === t.role && r.push(this.Dimension(s, e))
                        }
                ...
                return void 0 === c
                    ? null
                    : e
                    ? new is({ class: 'dimension', __tree__: c, role: a(l, t) })
                    : (function (t, e) {
                          var n = []
            ...
            (is.prototype.Category = function (t) {
                ...
                var l = (a.unit && a.unit[t]) || null,
                    s = (a.coordinates && a.coordinates[t]) || null,
                    u = (a.child && a.child[t]) || null,
                    c = (a.note && a.note[t]) || null
                return new is({ class: 'category', index: o, label: a.label[t], note: c, child: u, unit: l, coord: s })
            }),
            (is.prototype.Dice = function (t, e, n) {
                var r,
                    i,
                    a,
                    o,
                ...
                var s,
                    u = this.value,
                    c = r ? new is(JSON.parse(JSON.stringify(this))) : this,
                    f = c.status,
                    h = [],
                    p = [],
                    d = function (t, e) {
                    ...
                    g.length > 0 &&
                        ...
                        c.toTable({ type: 'arrobj', content: 'id', status: !0 }).forEach(function (e, n) {
                            ...
                            g.forEach(function (n) {
                                ...
                                -1 === r.indexOf(!1) && (h.push(e.value), p.push(e.status))
                        }),
                        g.forEach(function (e) {
                        ...
                        (c.value = c.__tree__.value =
                            as(u)
                                ...
                                : h),
                        (c.status = c.__tree__.status = null !== f ? p : null)),
                    i
                        ? ((s = c.__tree__).hasOwnProperty('id') ||
                              ((s.version = '2.0'),
                              s.hasOwnProperty('class') || (s.class = 'dataset'),
                              (s.id = s.dimension.id),
                              (s.size = s.dimension.size),
                              delete s.dimension.id,
                              delete s.dimension.size,
                              s.dimension.hasOwnProperty('role') && ((s.role = s.dimension.role), delete s.dimension.role)),
                          s.hasOwnProperty('status') &&
                              -1 !== ['null', '{}', '[]'].indexOf(JSON.stringify(s.status)) &&
                              delete s.status,
                          s.hasOwnProperty('role') &&
                              (delete s.role.classification,
                              ['geo', 'time', 'metric'].forEach(function (t) {
                                  null === s.role[t] && delete s.role[t]
                              })),
                          a && d(s, 'value'),
                          o && s.hasOwnProperty('status') && d(s, 'status'),
                          JSON.stringify(s))
                        : c
                )
            }),
            (is.prototype.Slice = function (t) {
                if (null === this || 'dataset' !== this.class) return null
            ...
            (is.prototype.Data = function (t, e) {
                var n,
                    r,
                    i = [],
                    a = function (t) {
                ...
                var l = 'object',
                    s = this.__tree__,
                    u = s.size || (s.dimension && s.dimension.size),
                    c = u.length
                if (Array.isArray(t)) {
                    if (!Array.isArray(t[0])) {
                        ...
                        if (1 === p.length) {
                            for (var g = 0, _ = d[0]; g < _; g++) {
                                var y = []
                                for (n = 0; n < c; n++) n !== p[0] ? y.push(t[n]) : y.push(g)
                ...
                var v = (function (t, e, n) {
                        ...
                        for (var c = 0, f = s.length; c < f; c++) {
                            var h = s[c],
                                p = e[h]
                            i.push('string' == typeof p ? p : 1 === u[c] ? a(l[h].category.index) : null)
                        }
                        return i
                    })(s, t, l),
                    m = [],
            ...
            (is.prototype.toTable = function (t, e) {
                if (null === this || 'dataset' !== this.class) return null
                ...
                if ('arrobj' === t.type || 'objarr' === t.type) {
                    var m = [],
                        ...
                        w = this,
                        T = w.id,
                        k = t.by && -1 !== T.indexOf(t.by) ? t.by : null,
                        z = !0 === t.meta,
                        F = void 0 !== t.drop && Array.isArray(t.drop) ? t.drop : [],
                        A = !0 === t.comma,
                        M = !0 === t.bylabel,
                        C = w.value.constructor,
                        E = function (e) {
                            var n,
                                r = {},
                                i = h(t.vlabel)
                                    ...
                                    ? ((r = {}),
                                      ...
                                      }),
                                      {
                                          meta: {
                                              ...
                                              by: k,
                                              bylabel: M,
                                              drop: null !== k && F.length > 0 ? F : null,
                                              prefix: null !== k ? H || '' : null,
                                              comma: A,
                                              dimensions: r,
                                          },
                                          data: e,
                    ...
                    if (null === k && t.unit && x) {
                        if ('id' !== t.content)
                            for (var N = x.length; N--; ) {
                                var P = this.Dimension(x[N])
                                S[x[N]] = {}
                                for (var D = P.length; D--; ) S[x[N]][P.Category(D).label] = P.id[D]
                            }
                        ;(b = function (e, n) {
                            if (-1 !== x.indexOf(e)) {
                                var r = d.dimension[e].category
                                r.unit ? (O.unit = r.unit['id' !== t.content ? S[e][n] : n]) : (O.unit = null)
                            }
                        }),
                            (t.unit = !0)
                    } else t.unit = !1
                    for (o = n.length, r = 0; r < o; r++) {
                        var O = {}
                        for (i = n[r].length; i--; ) (O[L[i]] = n[r][i]), b(L[i], n[r][i])
                        m.push(O)
                    }
                    if (
                        (A &&
                        ...
                        for (var V in ('id' !== t.content
                            ? M
                                ? (R = function (t, e, n) {
                                      t[e][H + n[k]] = n.value
                                  })
                                : (B.Category().forEach(function (t, e) {
                                      j[t.label] = B.id[e]
                                  }),
                                  (R = function (t, e, n) {
                                      t[e][H + j[n[k]]] = n.value
                        ...
                        m.forEach(function (t) {
                            var e = G(t, U)
                            void 0 === I[e] && (I[e] = q(t, U)), R(I, e, t, k)
                        }),
                        I))
                            W.push(I[V])
                        return (g = !1), E(W)
                ...
                if ('object' === t.type) {
                    var Y = 'number' == typeof this.value[0] || null === this.value[0] ? 'number' : 'string'
                    ;(l = function (t, e) {
                        var n = (f && t) || e || t
                        it.push({ id: t, label: n, type: 'string' })
                    }),
                        (s = function (t, e, n) {
                            var r = h(t),
                                i = p(e)
                            n && it.push({ id: 'status', label: i, type: 'string' }), it.push({ id: 'value', label: r, type: Y })
                        }),
                        (u = function (t) {
                            yt.push({ v: t })
                        }),
                        (c = function (t) {
                            yt.push({ v: t }), at.push({ c: yt })
                        })
                } else
                    (l = function (t, e) {
                        var n = (f && t) || e || t
                        ...
                        (s = function (t, e, n) {
                            var r = h(t),
                                i = p(e)
                            n && it.push(i), it.push(r), rt.push(it)
                        }),
                        (u = function (t) {
                            yt.push(t)
                        }),
                        (c = function (t) {
                            yt.push(t), rt.push(yt)
                        })
                var X = d.dimension,
                    K = d.id || X.id,
                    J = d.size || X.size,
                    Z = K.length
                if (Z != J.length) return !1
                var $ = [],
                    Q = 1,
                    tt = ((N = 1), []),
                    et = [],
                ...
                for (r = 0; r < Z; r++) {
                    ...
                    var st = []
                    for (i = 0; i < J[r]; i++)
                        for (var ut in X[K[r]].category.index)
                            if (X[K[r]].category.index[ut] === i) {
                                var ct = 'id' !== t.content && X[K[r]].category.label ? X[K[r]].category.label[ut] : ut
                                st.push(ct)
                            }
                    $.push(st), tt.push(N)
                }
                for (s(t.vlabel, t.slabel, g), o = $.length, r = 0; r < o; r++) {
                    for (var ft = [], ht = 0, pt = $[r].length; ht < pt; ht++)
                        for (var dt = 0; dt < Q / tt[r]; dt++) ft.push($[r][ht])
                    et.push(ft)
                }
                for (o = et.length, r = 0; r < o; r++) {
                    var gt = [],
                        _t = 0
                    for (a = 0; a < Q; a++) gt.push(et[r][_t]), ++_t === et[r].length && (_t = 0)
                    nt.push(gt)
                }
                for (a = 0; a < Q; a++) {
                    var yt = []
                    o = et.length
                    for (var vt = 0; vt < o; vt++) u(nt[vt][a])
                    g && u(this.status ? this.status[a] : null), c(this.value[a])
                }
                return 'object' === t.type ? { cols: it, rows: at } : rt
            }),
        ...
        var ss = function (t) {
                ...
                ;(e.get = function (t) {
                    ...
                    (e.set = function (t, r) {
                        ...
                        return (
                            i
                                ? r.value
                                    ? ((i.value = r.value), (i.status = r.status))
                                    : (i.value = isNaN(+r) ? r : +r)
                                : (n[t] = r.value ? r : { value: isNaN(+r) ? r : +r }),
                            e
                        )
                    }),
                    ...
                    (e.metadata = void 0),
                    (e.unitText_ = void 0),
                    (e.retrieveFromRemote = function (t, n, a) {
                        return e.eurostatDatasetCode_ ? r(t, n, a) : e.csvURL_ && i(a), e
                    }),
                    (e.eurostatDatasetCode_ = void 0),
                    (e.filters_ = { lastTimePeriod: 1 }),
                    (e.precision_ = 2)
                    ...
                    ;(n = null),
                        (function (t, n) {
                                ...
                                On(
                                    (function (t, e, n, r) {
                                        ...
                                        if (
                                            ...
                                            for (var a in e) {
                                                var o = e[a]
                                                if (Array.isArray(o)) for (var l = 0; l < o.length; l++) i.push('&', a, '=', o[l])
                                                else i.push('&', a, '=', o)
                                            }
                                        return i.join('')
                            ...
                            ;(e.metadata = {
                                ...
                                (e.metadata.time = r.Dimension('time').id[0]),
                                (n = (function (t) {
                ...
                ;(e.getTime = function () {
                    return e.filters_.time || (n ? e.metadata.time : void 0)
                }),
                    (e.csvURL_ = void 0),
                    (e.geoCol_ = 'geo'),
                    (e.valueCol_ = 'value')
        ...
        function vs(t, e) {
            ...
            function f(f) {
                var h = null == r ? (e.ticks ? e.ticks.apply(e, n) : e.domain()) : r,
                    p = null == i ? (e.tickFormat ? e.tickFormat.apply(e, n) : fs) : i,
                    d = Math.max(a, 0) + l,
                    g = e.range(),
                    _ = +g[0] + 0.5,
                    y = +g[g.length - 1] + 0.5,
                    v = (e.bandwidth ? _s : gs)(e.copy()),
                    m = f.selection ? f.selection() : f,
                    x = m.selectAll('.domain').data([null]),
                    b = m.selectAll('.tick').data(h, e).order(),
                    S = b.exit(),
                    w = b.enter().append('g').attr('class', 'tick'),
                    T = b.select('line'),
                    k = b.select('text')
                ;(x = x.merge(x.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', 'currentColor'))),
                    ...
                    f !== m &&
                        ...
                        w.attr('opacity', hs).attr('transform', function (t) {
                    ...
                    x.attr(
                        ...
                        4 === t || 2 == t
                            ? o
                                ? 'M' + s * o + ',' + _ + 'H0.5V' + y + 'H' + s * o
                                : 'M0.5,' + _ + 'V' + y
                            : o
                            ? 'M' + _ + ',' + s * o + 'V0.5H' + y + 'V' + s * o
                            : 'M' + _ + ',0.5H' + y
                    ),
            ...
            return (
                ...
                (f.ticks = function () {
                    return (n = cs.call(arguments)), f
                }),
                (f.tickArguments = function (t) {
                    return arguments.length ? ((n = null == t ? [] : cs.call(t)), f) : n.slice()
                }),
                (f.tickValues = function (t) {
                    return arguments.length ? ((r = null == t ? null : cs.call(t)), f) : r && r.slice()
                }),
        ...
        var bs = (function t(e) {
            ...
            Ss =
                ((function t(e) {
                    function n() {
                        var t = bs.source(e).apply(this, arguments)
                        return function () {
                            return Math.exp(t())
                        }
                    }
        ...
        Fs.prototype = As.prototype = {
                ...
                if (null === this._x1) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = e)
                    ...
                    if (Math.abs(c * l - s * u) > ks && i) {
                        var h = n - a,
                            ...
                            _ = Math.sqrt(d),
                            y = Math.sqrt(f),
                            v = i * Math.tan((ws - Math.acos((d + f - g) / (2 * _ * y))) / 2),
                            m = v / y,
                            x = v / _
                        Math.abs(m - 1) > ks && (this._ += 'L' + (t + m * u) + ',' + (e + m * c)),
                            (this._ +=
                                'A' +
                                i +
                                ',' +
            ...
            arc: function (t, e, n, r, i, a) {
                ...
                null === this._x1
                    ? (this._ += 'M' + s + ',' + u)
                    : (Math.abs(this._x1 - s) > ks || Math.abs(this._y1 - u) > ks) && (this._ += 'L' + s + ',' + u),
                    n &&
                        (f < 0 && (f = (f % Ts) + Ts),
                        f > zs
                            ? (this._ +=
        ...
        var Es = Math.abs,
            ...
            Hs = 2 * Ws
        function Us(t) {
            return t > 1 ? 0 : t < -1 ? Ws : Math.acos(t)
        }
        function Bs(t) {
            return t >= 1 ? js : t <= -1 ? -js : Math.asin(t)
        }
        function Gs(t) {
        ...
        function Ks(t, e, n, r, i, a, o, l) {
            var s = n - t,
                u = r - e,
                c = o - i,
                f = l - a,
                h = f * s - c * u
            if (!(h * h < Is)) return [t + (h = (c * (e - a) - f * (t - i)) / h) * s, e + h * u]
        }
        function Js(t, e, n, r, i, a, o) {
            var l = t - n,
                ...
                E = F - y
            return (
                A * A + M * M > C * C + E * E && ((T = z), (k = F)),
                { cx: T, cy: k, x01: -c, y01: -f, x11: T * (i / b - 1), y11: k * (i / b - 1) }
            )
        }
        function Zs() {
            var t = Gs,
            ...
            function s() {
                var s,
                    ...
                    h = i.apply(this, arguments) - js,
                    p = a.apply(this, arguments) - js,
                    d = Es(p - h),
                    g = p > h
                if ((l || (l = s = Ms()), f < c && ((u = f), (f = c), (c = u)), f > Is))
                    if (d > Hs - Is)
                        l.moveTo(f * Ns(h), f * Os(h)),
                            l.arc(0, 0, f, h, p, !g),
                            c > Is && (l.moveTo(c * Ns(p), c * Os(p)), l.arc(0, 0, c, p, h, g))
                    else {
                        var _,
                            y,
                            v = h,
                            ...
                            k = T > Is && (r ? +r.apply(this, arguments) : Rs(c * c + f * f)),
                            z = Ds(Es(f - c) / 2, +n.apply(this, arguments)),
                            F = z,
                            A = z
                        if (k > Is) {
                            var M = Bs((k / c) * Os(T)),
                                C = Bs((k / f) * Os(T))
                            ;(S -= 2 * M) > Is ? ((x += M *= g ? 1 : -1), (b -= M)) : ((S = 0), (x = b = (h + p) / 2)),
                                (w -= 2 * C) > Is ? ((v += C *= g ? 1 : -1), (m -= C)) : ((w = 0), (v = m = (h + p) / 2))
                        }
                        var E = f * Ns(v),
                            L = f * Os(v),
                            N = c * Ns(b),
                        ...
                        if (z > Is) {
                            var D,
                                ...
                                I = c * Ns(x),
                                W = c * Os(x)
                            if (d < Ws && (D = Ks(E, L, I, W, O, R, N, P))) {
                                var j = E - D[0],
                                    H = L - D[1],
                                    U = O - D[0],
                                    B = R - D[1],
                                    G = 1 / Os(Us((j * U + H * B) / (Rs(j * j + H * H) * Rs(U * U + B * B))) / 2),
                                    q = Rs(D[0] * D[0] + D[1] * D[1])
                                ;(F = Ds(z, (c - q) / (G - 1))), (A = Ds(z, (f - q) / (G + 1)))
                            }
                        }
                        w > Is
                            ? A > Is
                                ? ((_ = Js(I, W, E, L, f, A, g)),
                                  (y = Js(O, R, N, P, f, A, g)),
                                  l.moveTo(_.cx + _.x01, _.cy + _.y01),
                                  A < z
                                      ? l.arc(_.cx, _.cy, A, Ls(_.y01, _.x01), Ls(y.y01, y.x01), !g)
                                      : (l.arc(_.cx, _.cy, A, Ls(_.y01, _.x01), Ls(_.y11, _.x11), !g),
                                        l.arc(0, 0, f, Ls(_.cy + _.y11, _.cx + _.x11), Ls(y.cy + y.y11, y.cx + y.x11), !g),
                                        l.arc(y.cx, y.cy, A, Ls(y.y11, y.x11), Ls(y.y01, y.x01), !g)))
                                : (l.moveTo(E, L), l.arc(0, 0, f, v, m, !g))
                            : l.moveTo(E, L),
                            c > Is && S > Is
                                ? F > Is
                                    ? ((_ = Js(N, P, O, R, c, -F, g)),
                                      (y = Js(E, L, I, W, c, -F, g)),
                                      l.lineTo(_.cx + _.x01, _.cy + _.y01),
                                      F < z
                                          ? l.arc(_.cx, _.cy, F, Ls(_.y01, _.x01), Ls(y.y01, y.x01), !g)
                                          : (l.arc(_.cx, _.cy, F, Ls(_.y01, _.x01), Ls(_.y11, _.x11), !g),
                                            l.arc(0, 0, c, Ls(_.cy + _.y11, _.cx + _.x11), Ls(y.cy + y.y11, y.cx + y.x11), g),
                                            l.arc(y.cx, y.cy, F, Ls(y.y11, y.x11), Ls(y.y01, y.x01), !g)))
                                    : l.arc(0, 0, c, b, x, g)
                                : l.lineTo(N, P)
                    }
                else l.moveTo(0, 0)
            ...
            return (
                (s.centroid = function () {
                    var n = (+t.apply(this, arguments) + +e.apply(this, arguments)) / 2,
                        r = (+i.apply(this, arguments) + +a.apply(this, arguments)) / 2 - Ws / 2
                    return [Ns(r) * n, Os(r) * n]
                }),
                (s.innerRadius = function (e) {
                    return arguments.length ? ((t = 'function' == typeof e ? e : Cs(+e)), s) : t
                }),
                (s.outerRadius = function (t) {
                    return arguments.length ? ((e = 'function' == typeof t ? t : Cs(+t)), s) : e
                }),
                (s.cornerRadius = function (t) {
                    return arguments.length ? ((n = 'function' == typeof t ? t : Cs(+t)), s) : n
                }),
                (s.padRadius = function (t) {
                    return arguments.length ? ((r = null == t ? null : 'function' == typeof t ? t : Cs(+t)), s) : r
                }),
                (s.startAngle = function (t) {
                    return arguments.length ? ((i = 'function' == typeof t ? t : Cs(+t)), s) : i
                }),
                (s.endAngle = function (t) {
                    return arguments.length ? ((a = 'function' == typeof t ? t : Cs(+t)), s) : a
                }),
                (s.padAngle = function (t) {
                    return arguments.length ? ((o = 'function' == typeof t ? t : Cs(+t)), s) : o
                }),
        ...
        function nu() {
            ...
            function o(o) {
                var l,
                    ...
                    c = o.length,
                    f = !1
                for (null == r && (a = i((u = Ms()))), l = 0; l <= c; ++l)
                    !(l < c && n((s = o[l]), l, o)) === f && ((f = !f) ? a.lineStart() : a.lineEnd()),
                        f && a.point(+t(s, l, o), +e(s, l, o))
                if (u) return (a = null), u + '' || null
            }
            return (
                (o.x = function (e) {
                    return arguments.length ? ((t = 'function' == typeof e ? e : Cs(+e)), o) : t
                }),
                (o.y = function (t) {
                    return arguments.length ? ((e = 'function' == typeof t ? t : Cs(+t)), o) : e
                }),
                (o.defined = function (t) {
                    return arguments.length ? ((n = 'function' == typeof t ? t : Cs(!!t)), o) : n
                }),
                (o.curve = function (t) {
        ...
        function ru() {
            ...
            function s(s) {
                var u,
                    ...
                    _ = new Array(d),
                    y = new Array(d)
                for (null == a && (l = o((p = Ms()))), u = 0; u <= d; ++u) {
                    if (!(u < d && i((h = s[u]), u, s)) === g)
                        if ((g = !g)) (c = u), l.areaStart(), l.lineStart()
                        else {
                            for (l.lineEnd(), l.lineStart(), f = u - 1; f >= c; --f) l.point(_[f], y[f])
                            l.lineEnd(), l.areaEnd()
                        }
                    g && ((_[u] = +t(h, u, s)), (y[u] = +n(h, u, s)), l.point(e ? +e(h, u, s) : _[u], r ? +r(h, u, s) : y[u]))
                }
                if (p) return (l = null), p + '' || null
            }
            function u() {
                return nu().defined(i).curve(o).context(a)
            }
            return (
                (s.x = function (n) {
                    return arguments.length ? ((t = 'function' == typeof n ? n : Cs(+n)), (e = null), s) : t
                }),
                (s.x0 = function (e) {
                    return arguments.length ? ((t = 'function' == typeof e ? e : Cs(+e)), s) : t
                }),
                (s.x1 = function (t) {
                    return arguments.length ? ((e = null == t ? null : 'function' == typeof t ? t : Cs(+t)), s) : e
                }),
                (s.y = function (t) {
                    return arguments.length ? ((n = 'function' == typeof t ? t : Cs(+t)), (r = null), s) : n
                }),
                (s.y0 = function (t) {
                    return arguments.length ? ((n = 'function' == typeof t ? t : Cs(+t)), s) : n
                }),
                ...
                (s.curve = function (t) {
                    return arguments.length ? ((o = t), null != a && (l = o(a)), s) : o
                }),
                (s.context = function (t) {
                    return arguments.length ? (null == t ? (a = l = null) : (l = o((a = t))), s) : a
                }),
                s
            )
        }
        ...
        function ou() {
            ...
            function o(o) {
                var l,
                    ...
                    y = Math.min(Hs, Math.max(-Hs, i.apply(this, arguments) - _)),
                    v = Math.min(Math.abs(y) / h, a.apply(this, arguments)),
                    m = v * (y < 0 ? -1 : 1)
                for (l = 0; l < h; ++l) (f = g[(d[l] = l)] = +t(o[l], l, o)) > 0 && (p += f)
                for (
                    null != e
                        ? d.sort(function (t, n) {
                              return e(g[t], g[n])
                    ...
                    (s = d[l]),
                        (c = _ + ((f = g[s]) > 0 ? f * u : 0) + m),
                        (g[s] = { data: o[s], index: l, value: f, startAngle: _, endAngle: c, padAngle: v })
                return g
            }
            return (
                (o.value = function (e) {
                ...
                (o.startAngle = function (t) {
                    return arguments.length ? ((r = 'function' == typeof t ? t : Cs(+t)), o) : r
                }),
                (o.endAngle = function (t) {
                    return arguments.length ? ((i = 'function' == typeof t ? t : Cs(+t)), o) : i
                }),
                (o.padAngle = function (t) {
                    return arguments.length ? ((a = 'function' == typeof t ? t : Cs(+t)), o) : a
                }),
                o
            )
        }
            ...
            (lu.prototype = {
                ...
                insert: function (t, e) {
                    ...
                    if (t) {
                        ...
                        this._
                            ? ((t = fu(this._)), (e.P = null), (e.N = t), (t.P = t.L = e), (n = t))
                            : ((e.P = e.N = null), (this._ = e), (n = null))
                    for (e.L = e.R = null, e.U = n, e.C = !0, t = e; n && n.C; )
                        n === (r = n.U).L
                            ? (i = r.R) && i.C
                                ? ((n.C = i.C = !1), (r.C = !0), (t = r))
                                : (t === n.R && (uu(this, n), (n = (t = n).U)), (n.C = !1), (r.C = !0), cu(this, r))
                            : (i = r.L) && i.C
                            ? ((n.C = i.C = !1), (r.C = !0), (t = r))
                            : (t === n.L && (cu(this, n), (n = (t = n).U)), (n.C = !1), (r.C = !0), uu(this, r)),
                            (n = t.U)
                    this._.C = !1
                },
                remove: function (t) {
                    ...
                    if (
                        ...
                        a && o
                            ? ((r = n.C),
                              ...
                              (a.U = n),
                              n !== o
                                  ? ((i = n.U), (n.U = t.U), (t = n.R), (i.L = t), (n.R = o), (o.U = n))
                                  : ((n.U = i), (i = n), (t = n.R)))
                            : ((r = t.C), (t = n)),
                        t && (t.U = i),
                        !r)
                        ...
                        if (t && t.C) t.C = !1
                            ...
                            do {
                                ...
                                if (t === i.L) {
                                    if (
                                        ((e = i.R).C && ((e.C = !1), (i.C = !0), uu(this, i), (e = i.R)),
                                        (e.L && e.L.C) || (e.R && e.R.C))
                                    ) {
                                        ;(e.R && e.R.C) || ((e.L.C = !1), (e.C = !0), cu(this, e), (e = i.R)),
                                            (e.C = i.C),
                                            (i.C = e.R.C = !1),
                                            uu(this, i),
                                            (t = this._)
                                    ...
                                    ((e = i.L).C && ((e.C = !1), (i.C = !0), cu(this, i), (e = i.L)),
                                    (e.L && e.L.C) || (e.R && e.R.C))
                                ) {
                                    ;(e.L && e.L.C) || ((e.R.C = !1), (e.C = !0), uu(this, e), (e = i.L)),
                                        (e.C = i.C),
                                        (i.C = e.L.C = !1),
                                        cu(this, i),
                                        (t = this._)
        ...
        function pu(t, e, n, r) {
            ...
            return (
                ...
                n && gu(i, t, e, n),
                r && gu(i, e, t, r),
                Du[t.index].halfedges.push(a),
                Du[e.index].halfedges.push(a),
                i
            )
        }
        function du(t, e, n) {
                ...
                if (((a = r - s), h || !(a < 0))) {
                    ...
                    if (((a = n - u), p || !(a > 0))) {
                        ...
                        if (((a = i - u), p || !(a < 0))) {
                            ...
                            return (
                                !(c > 0 || f < 1) ||
                                (c > 0 && (t[0] = [s + c * h, u + c * p]), f < 1 && (t[1] = [s + f * h, u + f * p]), !0)
                            )
                        }
                    }
                }
        ...
        function yu(t, e, n, r, i) {
            ...
            } else if (((l = _ - (o = (f - p) / (d - h)) * g), o < -1 || o > 1))
                if (f > p) {
                    if (s) {
                        if (s[1] >= i) return
                    } else s = [(n - l) / o, n]
                ...
                if (r !== a) {
                    ...
                    if (!(h >= -Wu)) {
                        ...
                        ;(y.arc = t),
                            (y.site = i),
                            (y.x = g + o),
                            (y.y = (y.cy = _ + l) + Math.sqrt(g * g + _ * _)),
                            (t.circle = y)
                        for (var v = null, m = Ou._; m; )
        ...
        function ku(t) {
            var e = t.circle
            e && (e.P || (bu = e.N), Ou.remove(e), Su.push(e), su(e), (t.circle = null))
        }
        var zu = []
        function Fu() {
        ...
        function Mu(t) {
            ku(t), Pu.remove(t), zu.push(t), su(t)
        }
        function Cu(t) {
            var e = t.circle,
                n = e.x,
                ...
                l = [t]
            Mu(t)
            for (var s = a; s.circle && Math.abs(n - s.circle.x) < Iu && Math.abs(r - s.circle.cy) < Iu; )
                (a = s.P), l.unshift(s), Mu(s), (s = a)
            l.unshift(s), ku(s)
            for (var u = o; u.circle && Math.abs(n - u.circle.x) < Iu && Math.abs(r - u.circle.cy) < Iu; )
                (o = u.N), l.push(u), Mu(u), (u = o)
            l.push(u), ku(u)
            var c,
                f = l.length
            for (c = 1; c < f; ++c) (u = l[c]), (s = l[c - 1]), gu(u.edge, s.site, u.site, i)
            ;(s = l[0]), ((u = l[f - 1]).edge = pu(s.site, u.site, null, i)), Tu(s), Tu(u)
        }
        function Eu(t) {
            for (var e, n, r, i, a = t[0], o = t[1], l = Pu._; l; )
                if ((r = Lu(l, o) - a) > Iu) l = l.L
                else {
                    if (!((i = a - Nu(l, o)) > Iu)) {
                        r > -Iu ? ((e = l.P), (n = l)) : i > -Iu ? ((e = l), (n = l.N)) : (e = n = l)
                        break
                    }
                    if (!l.R) {
                        e = l
            ...
            !(function (t) {
                Du[t.index] = { site: t, halfedges: [] }
            })(t)
            var s = Au(t)
            if ((Pu.insert(e, s), e || n)) {
                if (e === n)
                    return ku(e), (n = Au(e.site)), Pu.insert(s, n), (s.edge = n.edge = pu(e.site, s.site)), Tu(e), void Tu(n)
                if (n) {
                    ku(e), ku(n)
                    var u = e.site,
                        c = u[0],
                        ...
                        v = h * h + p * p,
                        m = g * g + _ * _,
                        x = [(_ * v - p * m) / y + c, (h * m - g * v) / y + f]
                    gu(n.edge, u, d, x), (s.edge = pu(u, t, null, x)), (n.edge = pu(t, d, null, x)), Tu(e), Tu(n)
                } else s.edge = pu(e.site, s.site)
            }
        }
        function Lu(t, e) {
            var n = t.site,
            ...
            var c = l - r,
                f = 1 / a - 1 / u,
                h = c / u
            return f ? (-h + Math.sqrt(h * h - 2 * f * ((c * c) / (-2 * u) - s + u / 2 + i - a / 2))) / f + r : (r + l) / 2
        }
        function Nu(t, e) {
            var n = t.N
            if (n) return Lu(n, e)
        ...
        function Uu(t, e) {
            var n,
                ...
                i,
                a = t.sort(Hu).pop()
            for (Ru = [], Du = new Array(t.length), Pu = new hu(), Ou = new hu(); ; )
                if (((i = bu), a && (!i || a[1] < i.y || (a[1] === i.y && a[0] < i.x))))
                    (a[0] === n && a[1] === r) || (Eu(a), (n = a[0]), (r = a[1])), (a = t.pop())
                else {
                    if (!i) break
                    Cu(i.arc)
                }
            if (
                ((function () {
                    for (var t, e, n, r, i = 0, a = Du.length; i < a; ++i)
                        if ((t = Du[i]) && (r = (e = t.halfedges).length)) {
                            var o = new Array(r),
                                l = new Array(r)
                            for (n = 0; n < r; ++n) (o[n] = n), (l[n] = vu(t, Ru[e[n]]))
                            for (
                                o.sort(function (t, e) {
                                    return l[e] - l[t]
                                }),
                ...
                var o = +e[0][0],
                    ...
                    u = +e[1][1]
                !(function (t, e, n, r) {
                    for (var i, a = Ru.length; a--; )
                        (yu((i = Ru[a]), t, e, n, r) &&
                            _u(i, t, e, n, r) &&
                            (Math.abs(i[0][0] - i[1][0]) > Iu || Math.abs(i[0][1] - i[1][1]) > Iu)) ||
                            delete Ru[a]
                })(o, l, s, u),
                    (function (t, e, n, r) {
                        var i,
                        ...
                        for (i = 0; i < _; ++i)
                            if ((a = Du[i])) {
                                for (o = a.site, l = (s = a.halfedges).length; l--; ) Ru[s[l]] || s.splice(l, 1)
                                for (l = 0, u = s.length; l < u; )
                                    (d = (p = xu(a, Ru[s[l]]))[0]),
                                        (g = p[1]),
                                        (f = (c = mu(a, Ru[s[++l % u]]))[0]),
                                        (h = c[1]),
                                        (Math.abs(d - f) > Iu || Math.abs(g - h) > Iu) &&
                                            (s.splice(
                                                l,
                                                0,
                                                Ru.push(
                                                    du(
                                                        o,
                                                        p,
                                                        Math.abs(d - t) < Iu && r - g > Iu
                                                            ? [t, Math.abs(f - t) < Iu ? h : r]
                                                            : Math.abs(g - r) < Iu && n - d > Iu
                                                            ? [Math.abs(h - r) < Iu ? f : n, r]
                                                            : Math.abs(d - n) < Iu && g - e > Iu
                                                            ? [n, Math.abs(f - n) < Iu ? h : e]
                                                            : Math.abs(g - e) < Iu && d - t > Iu
                                                            ? [Math.abs(h - e) < Iu ? f : t, e]
                                                            : null
                                                    )
                                                ) - 1
                                            ),
                        ...
                        if (y) {
                            ...
                            for (i = 0, y = null; i < _; ++i)
                                (a = Du[i]) && (x = (v = (o = a.site)[0] - t) * v + (m = o[1] - e) * m) < b && ((b = x), (y = a))
                            if (y) {
                                var S = [t, e],
                                    w = [t, r],
                                    T = [n, r],
                        ...
                        for (i = 0; i < _; ++i) (a = Du[i]) && (a.halfedges.length || delete Du[i])
                    })(o, l, s, u)
            }
            ;(this.edges = Ru), (this.cells = Du), (Pu = Ou = Ru = Du = null)
        }
        function Bu(t, e) {
            ...
            if (!n) {
                if (
                    ...
                    (n = (function (t, e) {
                        if (t) {
                            if ('string' == typeof t) return Gu(t, e)
        ...
        Uu.prototype = {
                ...
                return (
                    this.cells.forEach(function (n, r) {
                        if ((a = (i = n.halfedges).length))
                            for (var i, a, o, l = n.site, s = -1, u = e[i[a - 1]], c = u.left === l ? u.right : u.left; ++s < a; )
                                (o = c),
                                    (c = (u = e[i[s]]).left === l ? u.right : u.left),
                                    o && c && r < o.index && r < c.index && ju(l, o, c) < 0 && t.push([l.data, o.data, c.data])
                    }),
                    t
                )
            },
            ...
            find: function (t, e, n) {
                for (var r, i, a = this, o = a._found || 0, l = a.cells.length; !(i = a.cells[o]); ) if (++o >= l) return null
                var s = t - i.site[0],
                    u = e - i.site[1],
                    c = s * s + u * u
                do {
        ...
        var qu = function (t, e) {
            ...
            if (
                ...
                (n.statData_ = { default: ss(), color: ss(), size: ss(), v1: ss(), v2: ss() }),
                ...
                (n.tooltip_.textFunction = Yu),
                (n.filtersDefinitionFun_ = void 0),
                (n.callback_ = void 0),
                (n.legend_ = void 0),
                (n.legendObj_ = void 0),
                [
            ...
            ;(n.legend = function (t) {
                ...
                (n.build = function () {
                    if (
                        ...
                        n.filtersDefinitionFun_ && n.filtersDefinitionFun_(n.svg(), n.clnb_),
                        n.legend())
                    ) {
                        n.legendObj(n.getLegendConstructor()(n, n.legend()))
                        var t = n.legendObj()
                        if (0 == dt('#' + t.svgId).size()) {
            ...
            return (
                ...
                (n.getLegendConstructor = function () {
                    return console.log('Map getLegendConstructor function not implemented'), us
                }),
                (n.getTime = function () {
                ...
                (n.exportMapToPNG = function () {
                    var t,
                        ...
                        o =
                            ...
                            (a.src = URL.createObjectURL(Vu(t))),
                            i)
                    return (
                        o.then(function (t) {
        ...
        var Yu = function (t, e) {
                var n = []
                t.properties.id
                    ? n.push('<b>' + t.properties.na + '</b> (' + t.properties.id + ') <br>')
                    : n.push('<b>' + t.properties.na + '</b><br>')
            ...
            Ku = function (t, e) {
                ...
                if (
                    ...
                    for (var r in e) n[r] = e[r]
                function i(t, e) {
                    var r = t.selectAll('#g_nutsrg').selectAll("[ecl='" + e + "']")
                    r.style('fill', n.map.nutsrgSelFillSty()),
                        r.attr('fill___', function () {
                            dt(this).attr('fill')
                        })
                }
                function a(t, e) {
                    t.selectAll('#g_nutsrg')
                        .selectAll("[ecl='" + e + "']")
                        .style('fill', function () {
                            dt(this).attr('fill___')
                        })
                }
                return (
                    (n.update = function () {
                        ...
                        for (
                            var l = n.labelFormatter ? n.labelFormatter : an('.' + n.labelDecNb + 'f'),
                                s = function () {
                                    var o = n.boxPadding + (n.title ? n.titleFontSize + n.boxPadding : 0) + u * n.shapeHeight,
                                        s = n.ascending ? t.clnb() - u - 1 : u
                                    r
                                        .append('rect')
                                        .attr('x', n.boxPadding)
                                        .attr('y', o)
                                        ...
                                        .attr('fill', t.classToFillStyle()(s, t.clnb()))
                                        .on('mouseover', function () {
                                            if ((dt(this).style('fill', t.nutsrgSelFillSty()), i(e, s), n.map.insetTemplates_)) {
                                                var r = n.map.insetTemplates_
                                                for (var a in r)
                                                    if (Array.isArray(r[a]))
                                                        for (var o = 0; o < r[a].length; o++)
                                                            if (Array.isArray(r[a][o]))
                                                                for (var l = 0; l < r[a][o].length; l++)
                                                                    r[a][o][l].svgId_ !== n.svgId_ && i(r[a][o][l].svg(), s)
                                                            else r[a][o].svgId_ !== n.svgId_ && i(r[a][o].svg(), s)
                                                    else r[a].svgId_ !== n.svgId_ && i(r[a].svg(), s)
                                            }
                                        })
                                        .on('mouseout', function () {
                                            if (
                                                (dt(this).style('fill', t.classToFillStyle()(s, t.clnb())),
                                                a(e, s),
                                                    ...
                                                    if (Array.isArray(r[i]))
                                                        for (var o = 0; o < r[i].length; o++)
                                                            if (Array.isArray(r[i][o]))
                                                                for (var l = 0; l < r[i][o].length; l++)
                                                                    r[i][o][l].svgId_ !== n.svgId_ && a(r[i][o][l].svg(), s)
                                                            else r[i][o].svgId_ !== n.svgId_ && a(r[i][o].svg(), s)
                                                    else r[i].svgId_ !== n.svgId_ && a(r[i].svg(), s)
                                            }
                                        }),
                                        u > 0 &&
                                            r
                                        ...
                                        u < t.clnb() - 1 &&
                                            r
                                                ...
                                                .text(l(t.classifier().invertExtent(s)[n.ascending ? 0 : 1]))
                        ...
                        if (n.noData) {
                            ...
                            r
                                ...
                                .on('mouseover', function () {
                                    if ((dt(this).style('fill', t.nutsrgSelFillSty()), i(e, 'nd'), n.map.insetTemplates_)) {
                                        var r = n.map.insetTemplates_
                                        for (var a in r)
                                            if (Array.isArray(r[a]))
                                                for (var o = 0; o < r[a].length; o++)
                                                    if (Array.isArray(r[a][o]))
                                                        for (var l = 0; l < r[a][o].length; l++)
                                                            r[a][o][l].svgId_ !== n.svgId_ && i(r[a][o][l].svg(), 'nd')
                                                    else r[a][o].svgId_ !== n.svgId_ && i(r[a][o].svg(), 'nd')
                                            else r[a].svgId_ !== n.svgId_ && i(r[a].svg(), 'nd')
                                    }
                                })
                                .on('mouseout', function () {
                                    if ((dt(this).style('fill', t.noDataFillStyle()), a(e, 'nd'), n.map.insetTemplates_)) {
                                        var r = n.map.insetTemplates_
                                        for (var i in r)
                                            if (Array.isArray(r[i]))
                                                for (var o = 0; o < r[i].length; o++)
                                                    if (Array.isArray(r[i][o]))
                                                        for (var l = 0; l < r[i][o].length; l++)
                                                            r[i][o][l].svgId_ !== n.svgId_ && a(r[i][o][l].svg(), 'nd')
            ...
            $u = {
                draw: function (t, e) {
                    var n = Math.sqrt(e / Ws)
                    t.moveTo(n, 0), t.arc(0, 0, n, 0, Hs)
                },
            },
            Qu = {
                draw: function (t, e) {
            ...
            nc = {
                draw: function (t, e) {
                    var n = Math.sqrt(e / ec),
                        r = n * tc
                    t.moveTo(0, -n), t.lineTo(r, 0), t.lineTo(0, n), t.lineTo(-r, 0), t.closePath()
                },
            },
            rc = Math.sin(Ws / 10) / Math.sin((7 * Ws) / 10),
            ic = Math.sin(Hs / 10) * rc,
            ac = -Math.cos(Hs / 10) * rc,
            oc = {
                draw: function (t, e) {
            ...
            uc = {
                draw: function (t, e) {
                    var n = -Math.sqrt(e / (3 * sc))
                    t.moveTo(0, 2 * n), t.lineTo(-sc * n, -n), t.lineTo(sc * n, -n), t.closePath()
                },
            },
            cc = -0.5,
            fc = Math.sqrt(3) / 2,
            ...
            dc = {
                draw: function (t, e) {
                    ...
                    t.moveTo(r, i),
                        t.lineTo(a, o),
                        t.lineTo(l, s),
                        t.lineTo(cc * r - fc * i, fc * r + cc * i),
                        t.lineTo(cc * a - fc * o, fc * a + cc * o),
                        t.lineTo(cc * l - fc * s, fc * l + cc * s),
                        t.lineTo(cc * r + fc * i, cc * i - fc * r),
                        t.lineTo(cc * a + fc * o, cc * o - fc * a),
                        t.lineTo(cc * l + fc * s, cc * s - fc * l),
                        t.closePath()
                },
            }
        function gc() {
            ...
            function r() {
                var r
                if ((n || (n = r = Ms()), t.apply(this, arguments).draw(n, +e.apply(this, arguments)), r))
                    return (n = null), r + '' || null
            }
            return (
                (r.type = function (e) {
                    return arguments.length ? ((t = 'function' == typeof e ? e : Cs(e)), r) : t
                }),
                (r.size = function (t) {
                    return arguments.length ? ((e = 'function' == typeof t ? t : Cs(+t)), r) : e
                }),
        ...
        var _c = function (t, e) {
                ...
                return (
                    (n.update = function () {
                        var t = n.map,
                            e = n.lgg
                        if (t.legend_)
                            for (var r in t.legend_)
                                if ('colorLegend' == r || 'sizeLegend' == r)
                                    for (var i in n[r]) t.legend_[r][i] && (n[r][i] = t.legend_[r][i])
                                else n[r] = t.legend_[r]
                        e.selectAll('*').remove(),
                            n.makeBackgroundBox(),
                            e.style('font-family', t.fontFamily_),
                            t.classifierSize_ &&
                                (function (t, e, r) {
                                    var i = r.labelFormatter || Dl
                                    r.title &&
                                        e
                                            .append('text')
                                            .attr('x', n.boxPadding)
                                    ...
                                    var a,
                                        ...
                                        s = (function () {
                                            var t
                                            if (n.map.psCustomPath_) t = n.map.psCustomPath_
                                                ...
                                                var e = vc[n.map.psShape_] || vc.circle
                                                t = gc().type(e)
                                            }
                                            return t
                                        })(),
                                    ...
                                    for (
                                        var c = 0,
                                            f = function () {
                                                var f,
                                                    p,
                                                    d = n.ascending ? r.cellNb - h + 1 : h,
                                                    g = r.values ? r.values[d - 1] : u / d,
                                                    _ = t.classifierSize_(g),
                                                    y = n.map.psCustomPath_ ? n.map.psCustomPath_ : s.size(_ * _)()
                                                if ('bar' == n.map.psShape_)
                                                    (f = n.boxPadding + 10),
                                                        (p =
                                                            n.boxPadding +
                                                            (r.title ? n.titleFontSize + r.titlePadding : 0) +
                                                            n._sizeLegendHeight),
                                                        (n._sizeLegendHeight = n._sizeLegendHeight + _ + r.shapePadding)
                                                else if ('custom' == n.map.psShape_) {
                                                    if (
                                                        ((n._xOffset = t.classifierSize_(u)),
                                                        (f = n.boxPadding + n._xOffset),
                                                        a ||
                                                            ((p =
                                                                n.boxPadding +
                                                                (r.title ? n.titleFontSize + r.titlePadding : 0) +
                                                            ...
                                                            (l = p),
                                                            (o = _),
                                                            (n._sizeLegendHeight = n._sizeLegendHeight + p)),
                                                        a)
                                                    ) {
                                                        var v = a.node().getBBox()
                                                        ;(c += v.height * o),
                                                            (p = l + c + r.shapePadding * (h - 1)),
                                                            (n._sizeLegendHeight =
                                                                n._sizeLegendHeight + v.height + r.shapePadding),
                                                            (o = _)
                                                    }
                                                } else
                                                    (n._xOffset = t.classifierSize_(u) / 1.5),
                                                        (f = n.boxPadding + n._xOffset),
                                                        (p =
                                                            n.boxPadding +
                                                            (r.title ? n.titleFontSize + r.titlePadding : 0) +
                                                ...
                                                a = e
                                                    .append('g')
                                                    .attr('transform', 'translate('.concat(f, ',').concat(p, ')'))
                                                    .style('fill', function (e) {
                                                    ...
                                                    .attr('transform', function () {
                                                        return n.map.psCustomPath_
                                                            ? 'translate('
                                                                  .concat(r.shapeOffset.x, ',')
                                                                  .concat(r.shapeOffset.y, ') scale(')
                                                                  .concat(_, ')')
                                                            : 'translate('
                                                                  .concat(r.shapeOffset.x, ',')
                                                                  .concat(r.shapeOffset.y, ')')
                                                    })
                                                var m = f + r.labelOffset.x,
                                                    x = p + r.labelOffset.y
                                                'bar' == n.map.psShape_
                                                    ? (x += _ / 2)
                                                    : 'custom' == n.map.psShape_ && (x += 10 * _),
                                                    e
                                                        .append('text')
                                                        .attr('x', m)
                                                        .attr('y', x)
                                ...
                                (function (t, e, r) {
                                        ...
                                        var o = n.boxPadding,
                                            ...
                                            s = function () {
                                                var s =
                                                        n._sizeLegendHeight +
                                                        n.boxPadding +
                                                        (r.title ? n.titleFontSize + 2 * r.titlePadding : 0) +
                                                        u * (r.shapeHeight + r.shapePadding) +
                                                        n.legendSpacing +
                                                        r.shapePadding,
                                                    c = n.ascending ? u : l - u - 1
                                                e.append('g')
                                                    .attr('transform', 'translate('.concat(o, ',').concat(s, ')'))
                                                    .attr('fill', t.psClassToFillStyle()(c, l))
                                                    .style('fill-opacity', t.psFillOpacity())
                                                    .style('stroke', t.psStroke())
                                                    ...
                                                    .on('mouseover', function () {
                                                        var e = a.select('#g_ps').selectAll("[ecl='" + c + "']"),
                                                            n = dt(this.parentNode).attr('fill')
                                                        dt(this).attr('fill___', n),
                                                            e.each(function (e, n) {
                                                                dt(this.childNodes[0]).style('fill', t.nutsrgSelFillSty())
                                                            }),
                                                            dt(this).style('fill', t.nutsrgSelFillSty())
                                                    })
                                                    .on('mouseout', function () {
                                                        var e = a.select('#g_ps').selectAll("[ecl='" + c + "']"),
                                                            n = dt(this).attr('fill___')
                                                        e.each(function (t, e) {
                                                            dt(this.childNodes[0]).style('fill', n)
                                                        }),
                                                            dt(this).style('fill', t.psClassToFillStyle()(c, l))
                                                    })
                                                var f = (n.map.psShape_, s)
                                                u > 0 &&
                                                    e
                                                        .append('line')
                                                        .attr('x1', o)
                                                        .attr('y1', f)
                                                        .attr('x2', o + r.sepLineLength)
                                                        .attr('y2', f)
                                                        .attr('stroke', r.sepLineStroke)
                                                        .attr('stroke-width', r.sepLineStrokeWidth)
                                                var h = s + r.labelOffset.y + 1.2 * n.labelFontSize
                                                u < l - 1 &&
                                                    e
                                                        .append('text')
                                                        .attr('x', o + r.labelOffset.x)
                                                        .attr('y', h)
                                                        .attr('alignment-baseline', 'middle')
                                                        .text(function (e) {
                                                            return i(
                                                                t.classifierColor_.invertExtent(n.ascending ? c + 1 : c - 1)[
                                                                    n.ascending ? 0 : 1
                                                                ]
                                                            )
                                                        })
                                    ...
                                    if (r.noData) {
                                        var c =
                                            n._sizeLegendHeight +
                                            n.boxPadding +
                                            (r.title ? n.titleFontSize + n.boxPadding + 2 * r.titlePadding : 0) +
                                            t.psClasses_ * (r.shapeHeight + r.shapePadding) +
                                            n.legendSpacing +
                                            r.shapePadding
                                        e
                                            .append('g')
                                            .attr('transform', 'translate('.concat(o, ',').concat(c, ')'))
                                            .attr('fill', t.noDataFillStyle())
                                            .style('fill-opacity', t.psFillOpacity())
                                            .style('stroke', t.psStroke())
                                            .attr('stroke-width', 1)
                                            ...
                                            .attr('height', r.shapeHeight)
                                            .on('mouseover', function () {
                                                var e = a.select('#g_ps').selectAll("[ecl='nd']"),
                                                    n = dt(this.parentNode).attr('fill')
                                                dt(this).attr('fill___', n),
                                                    e.each(function (e, n) {
                                                        dt(this.childNodes[0]).style('fill', t.noDataFillStyle())
                                                    }),
                                                    dt(this).style('fill', t.nutsrgSelFillSty())
                                            })
                                            .on('mouseout', function () {
                                                ...
                                                e.each(function (t, e) {
                                                    ...
                                                    dt(this).style('fill', t.noDataFillStyle())
                                            }),
                                            e
                                                .append('text')
                                                .attr('x', o + r.labelOffset.x)
                                                .attr('y', c + n.boxPadding)
                                                .attr('alignment-baseline', 'middle')
                                                .text(r.noDataText)
                                                .style('font-size', n.labelFontSize + 'px')
                                                .style('font-family', t.fontFamily_)
            ...
            vc = { cross: Qu, square: lc, diamond: nc, triangle: uc, star: oc, wye: dc, circle: $u },
            mc = function (t, e) {
                var n = []
                t.properties.id
                    ? n.push('<b>' + t.properties.na + '</b> (' + t.properties.id + ') <br>')
            ...
            xc = Mn('8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f'),
            bc = function (t, e) {
                var n = us(t)
                if (
                    ((n.shapeWidth = 13),
                                ...
                                a = function () {
                                    ...
                                    e
                                        ...
                                        e
                                            ...
                                            .on('mouseout', function () {
                                                var t = r.select('#g_nutsrg').selectAll("[ecl='" + l + "']"),
                                                    e = dt(this)
            ...
            Sc = function (t) {
                ...
                return (
                    ...
                    (e.noDataFillStyle_ = 'lightgray'),
                    (e.tooltip_.textFunction = wc),
                    (e.classifier_ = void 0),
                    ['classToFillStyle_', 'classToText_', 'noDataFillStyle_', 'tooltipText_', 'classifier_'].forEach(function (
                        t
                    ) {
                        e[t.substring(0, t.length - 1)] = function (n) {
                            return arguments.length ? ((e[t] = n), e) : e[t]
                    ...
                    (e.updateClassification = function () {
                        ...
                        return (
                            e.classifier(Gt().domain(t).range(n)),
                            e
                                .svg()
                    ...
                    (e.updateStyle = function () {
                        if (!e.classToFillStyle()) {
                            for (var t = {}, n = e.classifier().domain(), r = 0; r < n.length; r++) t[n[r]] = xc[r % 12]
                                    ...
                                    function () {
                                        a.on('mouseover', function (t) {
                                            ...
                                            n.attr('fill___', n.attr('fill')),
                                                n.attr('fill', e.nutsrgSelFillSty_),
                                                e._tooltip && e._tooltip.mouseover(e.tooltip_.textFunction(t, e))
                                        })
                                            .on('mousemove', function () {
                ...
                return (
                    (n.update = function () {
                        var t = n.map,
                            ...
                            i = t.clnb(),
                            a = n.squareSize / i,
                            o = 0.7071 * n.squareSize + n.boxPadding
                        r.selectAll('*').remove(),
                            n.makeBackgroundBox(),
                            n.title &&
                                r
                            ...
                            for (
                                var c = function () {
                                        ...
                                        s.append('rect')
                                            ...
                                            .on('mouseover', function () {
                                                var i = (
                                                    'mixed' == n.map.nutsLvl_ ? e.selectAll('#g_nutsrg') : e.select('#g_nutsrg')
                                                )
                                                    .selectAll("[ecl1='" + r + "']")
                                                    .filter("[ecl2='" + o + "']")
                                                i.style('fill', t.nutsrgSelFillSty()),
                                ...
                                c()
                        if (n.breaks1)
                            for (var h = 0; h < n.breaks1.length; h++)
                                s.append('text')
                                    .attr('x', a * (h + 1))
                                    .attr('y', n.squareSize + n.labelFontSize)
                                    .text(n.breaks1[h])
                                    .attr('text-anchor', 'middle')
                                    .style('font-size', n.labelFontSize + 'px')
                                    .style('font-family', t.fontFamily_)
                                    .style('fill', n.fontFill)
                        if (n.breaks2)
                            for (var p = 0; p < n.breaks2.length; p++) console.log('legend.breaks2 not yet implemented')
                        s
                            .append('text')
                            .attr('x', 0)
                            .attr('y', n.squareSize + n.labelFontSize + (n.breaks1 ? n.labelFontSize + 2 : 0))
                            .text(n.label1)
                            .style('font-size', n.labelFontSize + 'px')
                            .style('font-family', t.fontFamily_)
                            .style('fill', n.fontFill),
                            s
                                .append('text')
                                .attr('x', -n.labelFontSize)
                                .attr('y', n.labelFontSize)
                                .text(n.label2)
                                .attr('transform', 'rotate(90) translate(' + n.labelFontSize + ',0)')
                                .style('font-size', n.labelFontSize + 'px')
                                .style('font-family', t.fontFamily_)
                                .style('fill', n.fontFill),
                            s
                            ...
                            n.noData &&
                                ((l = l + 1.4142 * n.squareSize + 2 * n.boxPadding + n.labelFontSize),
                                r
                                    .append('rect')
                                    .attr('x', n.boxPadding)
                                    .attr('y', l)
                                    .attr('width', n.noDataShapeSize)
                                    .attr('height', n.noDataShapeSize)
                                    .attr('fill', t.noDataFillStyle())
                                    .attr('stroke', 'black')
                                    .attr('stroke-width', 0.7)
                                    .on('mouseover', function () {
                                ...
                                r
                                    .append('text')
                                    .attr('x', n.boxPadding + n.noDataShapeSize + n.boxPadding)
                                    .attr('y', l + 0.5 * n.noDataShapeSize)
                                    .attr('alignment-baseline', 'middle')
                                    .text(n.noDataText)
                                    .style('font-size', n.labelFontSize + 'px')
                                    .style('font-family', t.fontFamily_)
            ...
            kc = function (t, e) {
                ...
                if (!r || (0 != r.value && !r.value)) n.push(e.noDataText_)
                else {
                    n.push(r.value)
                ...
                n.push('<br>')
                var a = e.statData('v2').get(t.properties.id)
                if (!a || (0 != a.value && !a.value)) n.push(e.noDataText_)
                else {
                    n.push(a.value)
                    var o = e.statData('v2').unitText()
                    o && n.push(' ' + o)
                }
                return n.join('')
            },
            zc = Mn('1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf'),
            Fc = function (t, e) {
                var n = us(t)
                if (
                    ((n.shapeWidth = 13),
                                ...
                                r.values || (r.values = [Math.floor(i[1]), Math.floor(i[0])]),
                                    ...
                                    r.title &&
                                        e
                                            ...
                                            .style('font-family', t.fontFamily_)
                                            .style('fill', n.fontFill)
                                var a = t.sizeClassifier_(Ft(r.values)),
                                        ...
                                        e
                                            ...
                                            .on('mouseout', function () {
                                                i
                                                    ...
                                                    .selectAll("path[code='" + l + "']")
                                                    .style('fill', u),
                                                    dt(this).style('fill', u)
                                            }),
                                            e
                                                .append('text')
                                                .attr('x', n.boxPadding + r.shapeWidth + r.labelOffset)
                                                .attr('y', s + 0.5 * r.shapeHeight)
                                                .attr('alignment-baseline', 'middle')
                                                .text(t.catLabels()[l] || l)
                                                .style('font-size', n.labelFontSize + 'px')
                                                .style('font-family', t.fontFamily_)
                                                .style('fill', n.fontFill)
                                                .on('mouseover', function () {
                                                    i.selectAll('pattern')
                                                        .selectAll("rect[code='" + l + "']")
                                                        .style('fill', t.nutsrgSelFillSty())
                                                })
                                                .on('mouseout', function () {
            ...
            Mc = function (t, e) {
                return 'ch' == t
                    ? (function (t) {
                          ...
                          function n(t) {
                              ...
                              if ('quantile' === e.classifMethod_) {
                                  var i = e.statData().getArray(),
                                      a = n(e.clnb())
                                  e.classifier(zn().domain(i).range(a))
                                  ...
                                  var s = n(e.clnb())
                                  e.classifier(An().domain(e.threshold()).range(s))
                              }
                          ...
                          function i(t) {
                              if (
                                  (e.filtersDefinitionFun_
                                      ? e.classToFillStyle(function (t) {
                                            return 'url(#pattern_' + t + ')'
                                        })
                                      : e.classToFillStyle(Ju(e.colorFun(), e.colors_)),
                                  t.svg_)
                              ) {
                                  ...
                                  r
                                      ...
                                      .attr('fill', function (n) {
                                          if ('WORLD' == t.geo_) {
                                              var r = dt(this).attr('ecl')
                                              return r
                                                  ? 'nd' === r
                                                      ? e.noDataFillStyle() || 'gray'
                                                      : e.classToFillStyle()(r, e.clnb())
                                                  : e.nutsrgFillStyle_
                                          }
                                          if (e.countriesToShow_.includes(n.properties.id[0] + n.properties.id[1])) {
                                              var i = dt(this).attr('ecl')
                                              return i
                                                  ? 'nd' === i
                                                      ? e.noDataFillStyle() || 'gray'
                                                      : e.classToFillStyle()(i, e.clnb())
                                                  : e.nutsrgFillStyle_
                                          }
                                      ...
                                      .then(
                                          function () {
                                              r.on('mouseover', function (n) {
                                                  var r = dt(this)
                                                  r.attr('fill___', r.attr('fill')),
                                                      r.attr('fill', t.nutsrgSelFillSty_),
                                                      t._tooltip && t._tooltip.mouseover(t.tooltip_.textFunction(n, e))
                                              })
                                                  .on('mousemove', function () {
                                                      t._tooltip && t._tooltip.mousemove()
                                                  })
                                                  .on('mouseout', function () {
                                                      var e = dt(this)
                                                      e.attr('fill'),
                                                          e.attr('fill___') &&
                                                              (e.attr('fill', e.attr('fill___')),
                                                              t._tooltip && t._tooltip.mouseout())
                                                  })
                                          },
                                          function (t) {}
                                      ),
                                      'mixed' == e.nutsLvl_ &&
                                          t
                                              ...
                                              .style('display', function (e) {
                                                  var n = dt(this).attr('ecl'),
                                                      r = dt(this).attr('lvl')
                                                  return (n &&
                                                      t.countriesToShow_.includes(e.properties.id[0] + e.properties.id[1])) ||
                                                      '0' == r
                                                      ? 'block'
                                                      : 'none'
                                              })
                                              .style('stroke', function (e) {
                                                  var n = dt(this).attr('lvl')
                                                  if (dt(this).attr('ecl') && '0' !== n)
                                                      return t.nutsbnStroke_[parseInt(n)] || '#777'
                                              })
                                              .style('stroke-width', function (e) {
                                                  var n = dt(this).attr('lvl')
                                                  if (dt(this).attr('ecl') && '0' !== n)
                                                      return t.nutsbnStrokeWidth_[parseInt(n)] || 0.2
                                              }),
                          ...
                          return (
                              ...
                              (e.filtersDefinitionFun = function (t) {
                                  return arguments.length
                                      ? ((e.filtersDefinitionFun_ = t), e.svg() && e.filtersDefinitionFun_(e.svg(), e.clnb_), e)
                                      : e.filtersDefinitionFun_
                              }),
                              t &&
                                  [
                              ...
                              (e.updateValuesLabels = function () {
                                  return (
                                      e.svg_.selectAll('g.stat-label > *').remove(),
                                      e
                                          .svg()
                    ...
                    ? (function (t) {
                          ...
                          return (
                              ...
                              (e.psFill_ = '#2d50a0'),
                              (e.psFillOpacity_ = 0.7),
                              (e.psStroke_ = '#000'),
                              (e.psStrokeWidth_ = 0.3),
                              (e.psClasses_ = 5),
                              (e.psColors_ = null),
                              (e.psColorFun_ = Zu),
                              ...
                              (e.noDataFillStyle_ = 'lightgray'),
                              (e.psThreshold_ = [0]),
                              (e.psClassifMethod_ = 'quantile'),
                              (e.makeClassifNice_ = !0),
                              (e.classifierSize_ = void 0),
                              (e.classifierColor_ = void 0),
                              (e.tooltip_.textFunction = mc),
                              [
                                  'psMaxSize_',
                                  'psMinSize_',
                                  'psMaxValue_',
                              ...
                              (e.psColorFun = function (t) {
                                  return arguments.length
                                      ? ((e.psColorFun_ = t), (e.psClassToFillStyle_ = yc(e.psColorFun_, e.psColors_)), e)
                                      : e.psColorFun_
                              }),
                                  ...
                                  return (
                                      (function () {
                                          ...
                                          if (
                                              ...
                                              e.classifierSize(kn().domain(t).range([e.psMinSize_, e.psMaxSize_])),
                                              e.statData('color').getArray())
                                          )
                                              if ('quantile' === e.psClassifMethod_) {
                                                  var l = e.statData('color').getArray(),
                                                      s = n(e.psClasses_)
                                                  e.classifierColor(zn().domain(l).range(s))
                                                  ...
                                                  e.classifierColor(An().domain(e.psThreshold()).range(f))
                                              }
                                      })(),
                                      e.svg() &&
                                          e.classifierColor_ &&
                              ...
                              (e.updateStyle = function () {
                                  var t
                                  e.psClassToFillStyle() || e.psClassToFillStyle(yc(e.psColorFun_, e.psColors_))
                                  var n = e.statData('size').getArray() ? e.statData('size') : e.statData()
                                  if (e.svg()) {
                                      e.svg_.selectAll('g.symbol > *').remove(),
                                          (t = e.psCustomPath_
                                              ? e
                                                    .svg()
                                                    .select('#g_ps')
                                      ...
                                      var r = 'WORLD' == e.geo_ ? 'path.worldrg' : 'path.nutsrg',
                                          i = e.svg().selectAll(r)
                                      'WORLD' !== e.geo_
                                          ? ('mixed' == e.nutsLvl_ &&
                                                (e
                                            ...
                                            i.attr('fill', function (t) {
                                                return n.get(t.properties.id) ? e.nutsrgFillStyle_ : e.cntrgFillStyle_
                                            }))
                                          : i.attr('fill', function (t) {
                                                var r = n.get(t.properties.id)
                    ...
                    ? (function (t) {
                          ...
                          return (
                              ...
                              (e.updateClassification = function () {
                                  var t = r(Array(e.clnb()).keys())
                                  if (
                                      (e.classifier1_ || e.classifier1(zn().domain(e.statData('v1').getArray()).range(t)),
                                      e.classifier2_ || e.classifier2(zn().domain(e.statData('v2').getArray()).range(t)),
                                      e.svg())
                                  ) {
                                      if (
                                          (e
                                          ...
                                          var n = (function (t, e, n, r, i) {
                                              for (var a = [], o = ke(e, n), l = ke(r, i), s = 0; s < t; s++) {
                                                  for (var u = s / (t - 1), c = ke(o(u), l(u)), f = [], h = 0; h < t; h++)
                                                      f.push(c(h / (t - 1)))
                                                  a.push(f)
                                              }
                                              return function (t, e) {
                                  ...
                                  if (e.svg()) {
                                      e.svg()
                                          ...
                                          .attr('fill', function (t) {
                                              if (e.countriesToShow_.includes(t.properties.id[0] + t.properties.id[1])) {
                                                  var n = dt(this).attr('ecl1')
                                                  if (!n) return
                                                  if ('nd' === n) return e.noDataFillStyle() || 'gray'
                                                  var r = dt(this).attr('ecl2')
                                                  if (!r) return
                                                  return 'nd' === r ? e.noDataFillStyle() || 'gray' : e.classToFillStyle()(+n, +r)
                                              }
                                              return e.nutsrgFillStyle_
                                          })
                    ...
                    ? (function (t) {
                          ...
                          ;(e.stripeWidth_ = 50),
                              ...
                              (e.statComp = function (t, r, i, a, o) {
                                  ...
                                  for (var l = 0; l < i.length; l++) {
                                      ...
                                      e.stat(s, u),
                                          o && ((e.catColors_ = e.catColors_ || {}), (e.catColors_[s] = o[l])),
                                          a && ((e.catLabels_ = e.catLabels_ || {}), (e.catLabels_[s] = a[l]))
                                  }
                                  return (n = i), e
                              })
                          var n = void 0,
                          ...
                          return (
                              ...
                              (e.updateStyle = function () {
                                  if (!e.catColors()) {
                                      e.catColors({})
                                      for (var t = 0; t < n.length; t++) e.catColors()[n[t]] = zc[t % 10]
                                  }
                              ...
                              (e.tooltip_.textFunction = function (t, n) {
                                  ...
                                  var a = [],
                                      o = r(t.properties.id)
                                  for (var l in o) a.push({ code: l, value: o[l] })
                                  if (a && 0 != a.length) {
                                      var s = e.pieChartRadius(),
                                          u = e.pieChartInnerRadius(),
                                          c = i
                                              .append('svg')
                                              .attr('viewBox', [-s, -s, 2 * s, 2 * s])
                                              .attr('width', 2 * s),
                                          f = ou()
                                              .sort(null)
                                              .value(function (t) {
                                      ...
                                      c.append('g')
                                          ...
                                          .attr('d', Zs().innerRadius(u).outerRadius(s))
                    ...
                    ? (function (t) {
                          ...
                          ;(e.pieMinRadius_ = 5),
                              ...
                              (e.showOnlyWhenComplete_ = !1),
                              (e.noDataFillStyle_ = 'darkgray'),
                              (e.sizeClassifier_ = null),
                              (e.statPie_ = null),
                              [
                                  'catColors_',
                                  'catLabels_',
                          ...
                          var n = void 0,
                              r = void 0
                          e.statPie = function (t, i, a, o, l, s) {
                              t.filters = t.filters || {}
                              for (var u = 0; u < a.length; u++) {
                                  ...
                                  e.stat(c, f),
                                      l && ((e.catColors_ = e.catColors_ || {}), (e.catColors_[c] = l[u])),
                          ...
                          var i = function (t) {
                              for (var i = {}, a = 0, o = 0; o < n.length; o++) {
                                  var l = n[o],
                                      s = e.statData(l).get(t)
                                  if (!s || (0 != s.value && !s.value) || isNaN(s.value)) {
                                      if (e.showOnlyWhenComplete()) return
                                  } else (i[l] = s.value), (a += s.value)
                              }
                              if (r) {
                          ...
                          e.updateClassification = function () {
                              ...
                              var r,
                                  i =
                                      ...
                                      xt(r))
                              return (e.sizeClassifier_ = kn().domain(i).range([e.pieMinRadius_, e.pieMaxRadius_])), e
                          }
                          var a = function (t) {
                              var i,
                                  a = 0
                          ...
                          return (
                              (e.updateStyle = function () {
                                  ...
                                  var r = []
                                  if (e.svg()) {
                                      var o = e.svg().selectAll('#g_ps')
                                      if (o) {
                                          o.selectAll('g.symbol')
                                              .append('g')
                                              .attr('id', function (t) {
                                                  return r.push(t.properties.id), 'pie_' + t.properties.id
                                              })
                                          var l = 'WORLD' == e.geo_ ? 'path.worldrg' : 'path.nutsrg'
                                          e
                                              .svg()
                                              .selectAll(l)
                                              .on('mouseover', function (t) {
                                              ...
                                              r.forEach(function (t) {
                                                  var n = [],
                                                      r = i(t)
                                                  for (var o in r) n.push({ code: o, value: r[o] })
                                                  if (n && 0 != n.length) {
                                                      var l = e.svg().selectAll('#pie_' + t),
                                                          s = e.sizeClassifier_(a(t)),
                              ...
                              (e.tooltip_.textFunction = function (t, r) {
                                  var o = dt('#tooltip_eurostat')
                                  o.html(''),
                                      o.selectAll('*').remove(),
                                      t.properties.id
                                          ? o.append('div').html('<b>' + t.properties.na + '</b> (' + t.properties.id + ') <br>')
                                          : o.append('div').html('<b>' + t.properties.na + '</b><br>')
                                  var l = [],
                                      s = i(t.properties.id)
                                  ...
                                  if (l && 0 != l.length) {
                                      ...
                                      var b = a(t.properties.id)
                                      ;(_.innerHTML = _.innerHTML + '<hr><strong>Total</strong>: '.concat(b.toFixed(), ' <br>')),
                                          o.node().appendChild(_)
                                  } else o.append('div').html(e.noDataText())
                              }),
                              e
                          )
                      })(e)
                    ...
                    ? (function (t) {
                          ...
                          ;(e.sparkLineColor_ = 'black'),
                              ...
                              (e.statSpark = function (t, r, i) {
                                  ...
                                  for (var a = 0; a < r.length; a++) {
                                      ...
                                      e.stat(o, l), i && ((e.catLabels_ = e.catLabels_ || {}), (e.catLabels_[o] = i[a]))
                                  }
                                  return (n = r), e
                              })
                          var n = void 0,
                              r = function (t) {
                                  for (var r = [], i = 0, a = 0; a < n.length; a++) {
                                      ...
                                      if (!l || (0 != l.value && !l.value) || isNaN(l.value)) {
                                          if (e.showOnlyWhenComplete()) return
                                      } else r.push({ date: o, value: l.value }), (i += l.value)
                                  }
                                  if (0 != i) return r
                              }
                          ;(e.updateClassification = function () {
                              ...
                              var r,
                                  a =
                                      ...
                                      xt(r))
                              return (
                                  (e.widthClassifier_ = kn().domain(a).range([0, e.sparkLineWidth_])),
                                  (e.heightClassifier_ = kn().domain(a).range([0, e.sparkLineHeight_])),
                                  e
                              )
                          }),
                              (e.updateStyle = function () {
                                  ...
                                  return (
                                      ...
                                      t.forEach(function (t) {
                                          ...
                                          ;(i = e.svg().select('#spark_' + t)),
                                              ...
                                              'area' == e.sparkType_
                                                  ? ((u = e.widthClassifier_(c[1])),
                                                    (s = e.heightClassifier_(c[1])),
                                                    (l = mn()
                                                        .domain(c)
                                                        .range([s - 0.5, 0])),
                                                    (o = fn()
                                              ...
                                              'area' == e.sparkType_ &&
                                                  i
                                                      .append('path')
                                                      .datum(a)
                                                      .attr('fill', e.sparkAreaColor_)
                                                      .attr('stroke', e.sparkLineColor_)
                          ...
                          return (
                              ...
                              (e.tooltip_.textFunction = function (t, i) {
                                  var a = dt('#tooltip_eurostat')
                                  a.html(''),
                                      a.selectAll('*').remove(),
                                      t.properties.id
                                          ? a.append('div').html('<b>' + t.properties.na + '</b> (' + t.properties.id + ') <br>')
                                          : a.append('div').html('<b>' + t.properties.na + '</b><br>')
                                  var o = e.sparkTooltipChart_.height,
                                      l = e.sparkTooltipChart_.width,
                                      s = e.sparkTooltipChart_.margin,
                                      u = r(t.properties.id)
                                  !(function (t, r, i, a) {
                                      var o,
                                          l = xt(
                                      ...
                                      t.append('g')
                                          ...
                                          .call(((o = u), vs(3, o)).ticks(n.length).tickFormat(an('.0f')))
                                          .selectAll('text')
                                      ...
                                      var c = s.domain(),
                                          f = [c[0], Math.round((c[0] + c[1]) / 2), c[1]]
                                      t
                                          .append('g')
                                          .attr('class', 'axis')
                                          .call(
                                      ...
                                      a
                                          .append('svg')
                                          .attr('width', l + s.left + s.right)
                                          .attr('height', o + s.top + s.bottom)
                                          .append('g')
                    ...
                    : (console.log('Unexpected map type: ' + t), qu(e, !0))
            },
            Cc = function (t) {
